...
export const batch18Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Principle/Application",
...
$3000 \times V = 20,000$.
$V = 6.6$ m/s. The wreckage slides forward slowly. The danger is not momentum; it is the *Change in Momentum* (Impulse).
...
If you stop him slowly (Airbag), Time is large (0.1s), so Force is Small (Survival). Airbags and Crumple Zones extend the *Time* of impact. By buying milliseconds, they reduce the G-force to survivable levels. Physics dictates you cannot erase the energy, but you can spread it out. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Rise and Fall/Institution",
...
These boys were converted to Islam, circumcised, and trained in strict discipline. The smartest became Viziers (Ministers). The strongest became Janissaries.

They were "Slaves of the Sultan." They could not marry or own businesses. Their only loyalty was to the Sultan. This prevented the rise of rival noble families (who threatened European kings). Results: The Ottomans had the first professional standing army in Europe since Rome. They conquered Constantinople (1453).
...
They became a corrupt political mafia. When Sultans tried to modernize the army, the Janissaries rioted and killed the Sultans.
They went from being the Sultan's sword to the Sultan's cage.
In 1826, Sultan Mahmud II finally crushed them (The Auspicious Incident), blasting their barracks with cannons to clear the way for reform. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mystery/Hypothesis",
...
Theory 1: The Beak.
We found iron-rich crystals (Magnetite) in the nerve endings of the upper beak. We thought these acted like a compass needle, physically pulling the nerve to signal "North."
...
When light hits it, it creates a "Radical Pair" of entangled electrons. The spin of these electrons is affected by the magnetic field.
Essentially, the bird might *see* the magnetic field as a shading or color overlay on its vision. They also use smell (Olfactory Map) to recognize local landmarks near the loft.
It is a redundant system. If the magnets fail, they use the sun. If the sun fails, they use smell. `.trim(),
        questions: [
            {
...
Kerouac wrote it in three weeks on a single 120-foot scroll of paper so he wouldn't have to interrupt his flow to change pages. His style: "Spontaneous Bop Prosody."
He wanted to write like a Jazz musician plays saxophone—improvising, breathless, no editing.
"First thought, best thought." Critics hated it. Capote sneered, "That's not writing, that's typing."
But it electrified the youth. It birthed the Counter-Culture. The Beats became the Hippies of the 60s. They introduced Eastern spirituality (Zen) to the American mainstream.
They validated the idea that life is a search for meaning, not just a search for a mortgage. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Argument/Counter-Argument",
...
2.  **Freedom:** If you aren't desperate for survival, you can take risks. You can start a business, go back to school, or care for elderly parents. 3.  **Efficiency:** It replaces the nightmare bureaucracy of Welfare (food stamps, housing vouchers) with a simple cash transfer.

Arguments Against:
1.  **Cost:** It is astronomically expensive (trillions/year). It would require massive tax hikes.
2.  **Inflation:** If everyone has more money, prices might just go up (Rent increases by \$1000). 3.  **Work Ethic:** Critics fear people will stop working and play video games.

Pilot studies (Finland, Stockton) show mixed results. People generally *don't* quit their jobs (except new mothers and students). Mental health improves. History: Even Milton Friedman (conservative) supported a version called "Negative Income Tax." It is an idea that crosses the left-right divide, proposing a capitalist solution to a post-work future. `.trim(),
        questions: [
            {
...
It happens in Limestone (Calcium Carbonate). Rainwater absorbs $CO_2$ from the air and soil, becoming weak Carbonic Acid.
...
It deposits a tiny ring of Calcite. *   **Stalactites:** Hang tight from the Ceiling. (C = Ceiling).
*   **Stalagmites:** Grow might effectively from the Ground. (G = Ground). When they meet, they form a **Column**.

This process is slow—about 1 inch per century.
If you touch a formation, the oil from your finger prevents the water from sticking, stopping the growth forever. Caves are living geological galleries.
    `.trim(),
        questions: [
            {
...
In **Beer/Wine:**
We want the Alcohol. The $CO_2$ is either kept (fizzy beer) or vented (still wine). The alcohol kills bacteria, making beer safer to drink than water in the ancient world.

In **Bread:**
We want the $CO_2$. The gas bubbles get trapped in the gluten dough, making it rise (leaven).
The alcohol burns off during baking. Pasteur (1857) discovered yeast was alive. Before that, it was magic.
Bacteria perform a different fermentation: Lactic Acid.
$Sugar \\rightarrow Lactic Acid$.
This turns milk into Yogurt/Cheese and cabbage into Kimchi/Sauerkraut. The acid preserves the food by killing spoilage microbes.

Fermentation was humanity's first biotechnology. It allowed us to store calories (grain/milk) for the winter without refrigerators, enabling civilization to survive lean times.
`.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Innovation/Societal Impact",
        dominantSkill: "Inference",
        passage: `
...
They trick the brain (Pituitary Gland) into thinking the woman is *already pregnant*. The brain stops sending the signal to release an egg (Ovulation).
No egg = No baby.

It was the first medicine taken by *healthy* people for a social purpose.
Social Impact:
1.  **Education/Career:** Women could delay marriage. They flooded into universities and the workforce (law, medicine). The "Gender Pay Gap" began to close (slowly).
...
Some states banned it for unmarried women until 1972. Medical side effects (blood clots) were discovered later, leading to lower-dose versions. But "The Pill" remains the only drug simply known by a capital letter, a testament to its singular power.
    `.trim(),
        questions: [
            {
...
Level 1 (Base): **Physiological.** Food, water, sleep. If you are starving, you don't care about art. Level 2: **Safety.** Shelter, security, law.
Level 3: **Love/Belonging.** Friends, family, intimacy.
Level 4: **Esteem.** Respect, status, accomplishment.
Level 5 (Top): **Self-Actualization.** Achieving your full potential. Creativity, morality. "What a man can be, he must be." The Insight:
If a person is acting crazy or aggressive, look at their unmet needs. A hungry child cannot learn algebra (Level 5 task).
Corporations use this. A paycheck covers Level 1/2. But to keep talent, they must offer community (Level 3) and recognition (Level 4). Critiques:
It is Western-centric. In some cultures (Collectivist), belonging (Level 3) comes *before* individual safety or esteem.
The "Starving Artist" violates the rules: they sacrifice food (Level 1) for Art (Level 5). Maslow acknowledged this, noting the hierarchy isn't rigid, but general.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Future",
        dominantSkill: "Factual Information",
        passage: `
...
The outer layers of the Sun will expand massively. It will grow to swallow Mercury, Venus, and possibly Earth. The horizon will be a wall of fire.

Phase 2: **Helium Flash.**
The core gets hot enough to fuse Helium into Carbon. It stabilizes briefly.

Phase 3: **Planetary Nebula.**
The Sun is not big enough to explode (Supernova). It will gently shed its outer layers into space, creating a beautiful glowing cloud. Phase 4: **White Dwarf.**
The only thing left is the core. A ball of carbon the size of Earth but with the mass of the Sun.
It is incredibly dense (one teaspoon = 5 tons). It has no fuel. It just glows from leftover heat.

Phase 5: **Black Dwarf.**
Over trillions of years, the White Dwarf cools down and goes dark. A cold diamond floating in the void. Since the universe is not old enough yet (13.8 billion years), no Black Dwarfs exist today.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Process",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
1.  **Separation:** The person is removed from their old identity/group.
    Example: A recruit gets his head shaved and leaves home for Bootcamp. He is no longer a civilian. 2.  **Liminality (The Threshold):** The middle stage.
    ...
    This creates *Communitas*—an intense bond with fellow initiates. They are all equal in the mud. 3.  **Incorporation (Re-aggregation):** The person re-enters society with a *new* identity.
    Example: The graduation ceremony. You move the tassel. You are now a "Graduate." Societies need these rituals to map the social clock. If we skip them, people feel lost. (The "Peter Pan Syndrome" of endless adolescence might be due to a lack of clear rituals marking adulthood). Van Gennep showed that transitions are dangerous, and rituals build the bridge to get us safely to the other side.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Style/Impact",
        dominantSkill: "Prose Summary",
        passage: `
...
He built a shimmering, curvy, metallic flower. It has no straight lines.
To build it, he had to use CATIA—software designed for fighter jets—because traditional blueprints couldn't describe the shapes. The "Bilbao Effect":
The building was so famous that millions of tourists flocked to see it. It single-handedly revived the city's economy.
Suddenly, every city wanted a "Starchitet" to build a weird icon to put them on the map. Critics say Deconstructivism is just sculpture, not architecture. It ignores function (curved walls are hard to hang art on). But Gehry argued that in a chaotic world, boxes are a lie; chaos is the truth. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Perspective/Contrast",
        dominantSkill: "Negative Factual Information",
        passage: `
...
2.  **Archery:** The composite bow could kill at 300 yards. They could shoot while riding backward (Parthian Shot). 3.  **Terror:** If a city surrendered, they were spared. If they resisted, everyone was killed. This reputation meant the next ten cities surrendered without a fight.

The Paradox: **Pax Mongolica** (Mongol Peace).
Once they conquered the Silk Road, they made it safe.
A maiden with a pot of gold could walk from the Black Sea to China unharmed. Trade flourished. Ideas traveled.
Gunpowder, paper, and the compass moved from China to Europe.
They were religiously tolerant (Genghis prayed with Christians, Muslims, and Buddhists). However, the trade routes also carried the Black Death (Plague). The bacteria Yersinia pestis hitched a ride on Mongol supply trains, eventually killing half of Europe. The Mongols connected the world, for better and for worse.
    `.trim(),
        questions: [
            {
...
But at the *surface*, there are no neighbors above. The molecule is pulled only *down* and *sideways*.
...
They distribute their weight so they don't break the "rubber sheet." You can see dimples where their feet push the water down.

Soap breaks this (Surfactant).
If you add a drop of soap to the pond, it disrupts the H-bonds.
The "skin" snaps. The Water Strider sinks instantly and drowns.

This is also why rain forms drops (spheres). The surface tension pulls the water into the shape with the smallest surface area: a sphere. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution (Biological)",
        dominantSkill: "Sentence Insertion",
        passage: `
...
Telomeres are the plastic tips at the end of shoelaces (Chromosomes). They protect the DNA from fraying.
...
When it's gone, the cell starts eating into valuable genes. The cell shuts down to prevent cancer. This is Aging.

But Cancer cells are immortal. How?
They activate an enzyme called *Telomerase*.
Telomerase rebuilds the tips. It resets the clock.
...
But we might also give everyone super-cancer. Evolution chose death over cancer.
    `.trim(),
        questions: [
            {
...
This feeling is the **Sublime**—a mix of awe and terror. Themes:
1.  **Light:** "Luminism." A golden, divine glow.
2.  **Man is Small:** Tiny figures are often shown in the corner, overwhelmed by giant trees or mountains. 3.  **The Course of Empire:** Thomas Cole warned that civilization destroys nature. He painted a series showing a city rising from the wild, becoming an empire, and then falling into ruin.

It was propaganda for Manifest Destiny.
By showing the West as a glorious Eden, they encouraged expansion.
But they were also proto-conservationists. They documented the wilderness before the railroads and sawmills destroyed it. Their art helped convince Lincoln to create the first protected parkland (Yosemite Grant, 1864). `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Event/Demographics",
        dominantSkill: "Negative Factual Information",
        passage: `
...
Impact:
1.  **Population:** San Francisco went from a village of 200 people to a city of 36,000 in two years. 2.  **Diversity:** California became the most diverse place on earth.
...
Levi Strauss sold denim pants (Levi's) that wouldn't rip. Sam Brannan bought all the shovels in the city for \$1 and sold them for \$15.

Law and Order:
There was no government. It was the Wild West.
Vigilante gangs ruled San Francisco.
Racism led to the Chinese Exclusion Act later on. California became a state in 1850. The Gold Rush fast-forwarded American history, skipping the "territory" phase. It shifted the center of gravity to the Pacific. It cemented the American Dream: the idea that you can go West and reinvent yourself overnight with a lucky strike.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Metaphor/Evidence",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
It is distinct from the "Sticky Floor" (keeping women in low-wage jobs) or the "Glass Cliff" (promoting women to leadership only when the company is failing and likely to crash). Causes:
1.  **Implicit Bias:** We unconsciously associate "Leader" with "Male/Tall/Deep Voice."
2.  **The Old Boys' Club:** Networking happens on the golf course or at late-night drinks. If women are excluded (or go home to kids), they lose connections. 3.  **The Motherhood Penalty:** Women take maternity leave. Men don't. Women are seen as "distracted." Fathers are often actually given a "Fatherhood Bonus" (paid more because they are "providers").

The "Queen Bee Syndrome."
Sometimes, a woman who breaks the ceiling *doesn't* help other women up. She pulls the ladder up. She feels she had to survive a tough male world, so the young women should too.

Progress is slow. In the Fortune 500, women CEOs are still rare (<10%). The ceiling is cracking, but the shards are sharp.
    `.trim(),
        questions: [
            {
...
Wings: Three wings stick out from the center. The wings prop each other up.
...
The Burj Khalifa changes shape as it goes up. It steps back in a spiral. The wind is "confused." It never organizes into a coherent vortex. The forces cancel out.

Result:
It is rigid.
It uses surprisingly little material. It enables the "Supertall" era. The Kingdom Tower (Jeddah) plans to use this aiming for 1000m. The limit now is not structure, but elevators (how fast can you go before ears pop?). `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Significance",
        dominantSkill: "Inference",
        passage: `
...
Genetic analysis found a mutation in one specific gene: FOXP2 on Chromosome 7. This was the "Language Gene" (oversimplified, but important).
...
About 200,000 years ago (when humans appeared), our version mutated to the "Super-Speech" version. Neanderthals? We checked their DNA. They had the *human* version. This implies Neanderthals could speak. They weren't grunting brutes.

This gene is a "Transcription Factor"—it controls dozens of other genes. It unlocked the hardware for speech, allowing culture to explode.
    `.trim(),
        questions: [
            {
