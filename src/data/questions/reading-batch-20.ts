...
export const batch20Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Definition/Distinction",
...
It happens because objects don't vibrate at just one frequency. They vibrate at a *Fundamental Frequency* (the main note) plus a series of *Overtones* (Harmonics). *   Piano: Strong 2nd and 3rd harmonics.
...
The shape of the box is tuned to amplify specific frequencies. A Stradivarius violin is famous because the wood and varnish create a uniquely beautiful set of resonances.

Soldiers marching on a bridge break step. Why?
If they march in unison at the bridge's *Resonant Frequency*, the bridge will start to swing. The swings get bigger and bigger until it snaps (see Tacoma Narrows, Batch 17). Resonance is the power of adding small pushes at the right time. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Tactics",
...
The Suffragettes paused their campaign to support the war effort. Women worked in munitions factories ("Canaries"—their skin turned yellow from TNT). They proved they could do "men's work."
The argument "Women are too fragile for politics" collapsed.
In 1918, women over 30 got the vote. In 1928, equal to men (21).

In the US, Alice Paul copied these militant tactics (picketing the White House during wartime). President Wilson finally caved, leading to the 19th Amendment (1920). The victory was won not by logic, but by disruption.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Paradigm Shift/Phenomenon",
...
When the soldier shaves his face, the nerves cross-fire, and he feels it in his missing thumb. V.S. Ramachandran cured this with the **Mirror Box**.
...
The brain sees the "phantom" moving and relaxing. It updates the map. The pain vanishes. Plasticity also explains learning. "Neurons that fire together, wire together." London Taxi drivers (who memorize 25,000 streets) have a physically larger Hippocampus (memory center) than normal people. The brain grows like a muscle. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Style/Theme",
...
Themes:
1.  **Decay:** The crumbling plantation house. The impoverished aristocratic family living in squalor. It represents the South unable to move on after the Civil War.
2.  **The Grotesque:** Characters are physically or mentally broken. (A man with a wooden leg, an idiot, a refreshing misfit). This outer damage reflects inner moral rot. 3.  **The Past:** "The past is never dead. It's not even past." (Faulkner). The characters are haunted by the sins of their ancestors (slavery).

O'Connor used violence to shock characters into grace. In her stories, a grandmother only realizes her own hypocrisy when a serial killer puts a gun to her head. The genre suggests that underneath the polite manners and sweet tea of the South lies a swamp of trauma that refuses to stay buried. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Scenario/Implication",
...
*   If both stay silent (Cooperates): Both get 1 year. The Rational Choice:
...
Individual rationality leads to collective stupidity. This explains:
...
To solve it, you need an enforcer (Mafia boss/International Treaty) to punish betrayal, or "Repeated Games" where reputation matters. Without trust, math dictates conflict. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Hypothesis/Rejection/Proof",
...
Evidence:
1.  **Fossils:** He found the same lizard (*Mesosaurus*) in Brazil and Africa. It couldn't swim the ocean. 2.  **Rocks:** The Appalachian Mountains (US) match the mountains in Scotland. They are the same range, torn in half.
...
Why? He had no **Mechanism**. He couldn't explain *how* massive continents plowed through the solid ocean floor. He guessed "Centrifugal Force." Physicists proved that was impossible. He died in a blizzard in Greenland, considered a failure.
...
The continents don't plow through the floor; they ride on top of the moving floor plates like a conveyor belt. Heat form the core (Convection Currents) drives the belt.
Wegener was right about *what* happened, but wrong about *how*. Today, Plate Tectonics is the unifying theory of geology.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Principles/Application",
...
3.  **Heat:** Activation energy to start the reaction. If you remove **one** side of the triangle, the fire dies.

Application (Firefighting):
*   **Water:** Removes the **Heat**. It cools the fuel below the ignition point. *   **Foam/Blanket:** Removes the **Oxygen**. It smothers the fire.
...
Halon gas extinguishers work by interrupting the chemical bonding process, stopping the fire without water or foam. Backdraft:
...
The Triangle is completed instantly and explosively. Firefighters must ventilate the roof first to let the heat out before opening the door.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Innovation/Impact",
        dominantSkill: "Inference",
        passage: `
...
The Escapement catches the gear, holds it, and releases it. *Tick. Tock.* It divides continuous time into discrete units.

Monasteries spurred the invention. Monks needed to pray at exact times (Matins, Vespers) regardless of the sun. The first clocks were alarms to ring bells. Impact:
...
3.  **Navigation:** To find Longitude at sea, you need a clock that works on a rocking boat (Chronometer, Harrison, 1760). Lewis Mumford argued the clock, not the steam engine, was the key machine of the Industrial Age. It synchronized humanity, turning us into cogs in a global machine.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Experiment/Result",
        dominantSkill: "Prose Summary",
        passage: `
...
As shocks increase, the Learner screams, begs, and then plays dead. The Teacher wants to stop. He looks at the Experimenter.
...
Reality: **65%** went all the way to 450V. They were sweating and trembling, but they obeyed.

Conclusion:
Evil is not always a character trait. It is a situation.
People enter an "Agentic State." They view themselves as instruments of the authority. "I am just doing my job. He is responsible." This "Banality of Evil" (Arendt) suggests that under the right pressure, normal people can do terrible things. `.trim(),
        questions: [
            {
...
According to the math, opening your oven should blast you with X-rays and destroy the universe. This obviously doesn't happen.
...
High frequency light (UV) costs a lot of energy to make. It is "expensive." The oven doesn't have enough energy to buy the "UV Packet." It can only afford the "Infrared/Red Packet."
So the curve drops off. The catastrophe is avoided.

Planck didn't believe his own idea. He thought it was just a math trick. But Einstein took it seriously and built Quantum Mechanics.
Everything digital (lasers, chips, MRIs) comes from this one trick to fix a lightbulb theory. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Phenomenon/Interpretation",
        dominantSkill: "Inference",
        passage: `
During WWII, American troops landed on remote islands in Melanesia. They brought "Cargo"—tinned food, Jeeps, radios, Coca-Cola.
The indigenous islanders were amazed. They saw the soldiers didn't make these things (they didn't fish or farm). They just marched in lines, raised flags, and the Cargo fell from the sky (planes). Conclusion: The Cargo comes from the Gods/Ancestors. The Americans know the correct ritual (Marching/Flags) to summon it.
...
They marched with painted sticks (rifles). They were trying to perform the ritual to call the planes back.
...
We all have Cargo Cults. We follow rituals (diets, dress codes, investment fads) hoping for a result we don't fully understand. `.trim(),
        questions: [
            {
...
It looks like a giant wrapped present with ribbons. It has fake columns and bright pastel colors. Example: The **AT&T Building** (Philip Johnson).
It looks like a standard skyscraper, but the top is a Chippendale Cabinet (a broken pediment). Critics called it "Las Vegas" architecture—tacky and shallow.
But PoMo argued that buildings should speak to the public, not just to elite logic. They should have "Context."
A library should look like a library (maybe have columns), not a factory. The **Piazza d'Italia** in New Orleans creates a neon-lit fake Roman ruin. It acknowledges that history is a playground. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Event/Analysis",
        dominantSkill: "Negative Factual Information",
        passage: `
...
Chamberlain agreed. He gave Hitler the land (without asking the Czechs). Chamberlain returned to London waving a paper: "Peace for our time." He was a hero.

Why?
People forget that many British nobles were sympathetic to Germany, or feared Stalin (Communism) more. They saw Hitler as a buffer against Russia. Also, Britain was not ready to fight. They needed time to build Spitfires.
...
Lesson:
However, historians argue that if war started in 1938, Britain might have lost. The delay allowed the RAF to prepare for the Battle of Britain. It was a moral failure, but perhaps a strategic necessity.
    `.trim(),
        questions: [
            {
...
You can start a current flowing in a loop, walk away for a year, come back, and it is still flowing. Perpetual motion (almost).

Meissner Effect:
Superconductors hate magnetic fields. They expel them.
If you put a magnet on top of a superconductor, it *Levitates* (Quantum Locking). Mechanism (BCS Theory):
...
The Holy Grail is a **Room Temperature Superconductor**. If we find one:
*   Lossless power grids (Solar in Sahara powering London).
*   MRI machines in every doctor's office. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Discovery",
        dominantSkill: "Sentence Insertion",
        passage: `
...
Conclusion: Citrus prevents Scurvy. (Hence "Limeys" for British sailors). But they didn't know *why*. They thought it was acid.
...
*   Vitamin C makes Collagen (glue for skin). No C = You fall apart (Scurvy). *   Vitamin D absorbs Calcium. No D = Soft bones (Rickets).

Fortification:
In the 20th century, governments started adding vitamins to food.
*   Iodine in Salt (prevents Goiter/Brain damage). *   Folic Acid in Flour (prevents birth defects).
*   Vitamin D in Milk.
This ended nearly all deficiency diseases in the developed world. It is the cheapest public health miracle in history. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Reaction",
        dominantSkill: "Prose Summary",
        passage: `
...
The point is the *presence* of the object in the space. You focus on the light, the scale, and the material. Frank Stella (painter): "What you see is what you see."
He painted black stripes. Nothing else.

Why?
They wanted to purify art. To strip away the deception of illusion. If you paint a tree, you are lying (it's 2D canvas, not a tree).
If you put a metal box on the floor, it is true. It is a box.

Critiques: "Is this art?"
It forces the viewer to deal with their own boredom and awareness. It influenced design (Apple, IKEA). The "Minimalist" aesthetic of clean lines and white space comes directly from these factory-made boxes. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Transformation",
        dominantSkill: "Factual Information",
        passage: `
...
Jews were blamed (poisoning wells) and massacred. Long-Term Revolution (The Silver Lining):
1.  **Labor Shortage:** Half the peasants died.
    Suddenly, labor was scarce. The survivors could demand higher wages.
    The Feudal System (Serfdom) collapsed. Peasants became free workers. 2.  **The Church:** Many good priests died (tending the sick). The Church replaced them with uneducated/corrupt men. Faith in the Church's power to protect crumbled, paving the way for the Reformation. 3.  **Technology:** Expensive labor incentivized labor-saving machines (Printing Press).

The Plague ended the Middle Ages. By thinning the herd, it concentrated wealth and freedom in the survivors, setting the stage for the Renaissance.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem/Inequality",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
Women did "daily" chores (dinner, laundry). Consequences:
...
*   **Cutting Back:** The woman reduces her career ambition to manage Home. (The Glass Ceiling again). *   **Outsourcing:** Hiring nannies/cleaners. (Fixes the problem for the rich woman by shifting the burden to a poorer woman). Things have improved (Millennial dads do more), but the "Mental Load" (remembering birthdays, scheduling doctors) still falls disproportionately on women. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Definition/Risk",
        dominantSkill: "Inference",
        passage: `
...
*   **Smart Home:** Your thermostat learns when you leave and lowers the heat to save money. Your fridge orders milk when you run low. *   **Industry 4.0:** A jet engine reports its own vibration in real-time to the mechanic before it breaks. (Predictive Maintenance).
...
In 2016 (Mirai Botnet), hackers took over 300,000 webcams and DVRs to crash the internet (DDoS attack). Worse: Physical harm.
If a hacker crashes your computer, you lose data.
If a hacker hacks your Smart Car or Pacemaker, you lose your life. Privacy: Your robotic vacuum maps your house. Your Smart TV listens to your conversations. IoT turns the physical world into a surveillance device, forcing us to trade privacy for convenience.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Hypothesis/Comparison",
        dominantSkill: "Sentence Insertion",
        passage: `
...
Standing up allowed us to see predators over the tall grass. Theory 2: **Thermoregulation.**
...
This is the **Persistence Hunting** theory. We chased antelope until they died of heat exhaustion. Theory 4: **Freeing the Hands.**
If you don't need hands to walk, you can carry things.
Food. Babies. And crucially: **Tools**. Once hands were free, we could make stone axes. This drove the evolution of the brain (to use the tools).
Bipedalism freed the hands, and the hands built the mind. `.trim(),
        questions: [
            {
