...
The Earth spins faster at the Equator (1000 mph) than near the poles (slow). When air moves from the North (slow) towards the Equator (fast), the ground beneath it speeds up. The air "lags behind" the spinning ground. To an observer on the ground, the wind seems to curve.
...
This spins hurricanes. Low pressure sucks air in. As the air rushes in, Coriolis spins it.
Northern hurricanes spin Counter-Clockwise.
Southern Cyclones spin Clockwise.
Interestingly, at the exact Equator, there is no Coriolis effect. That is why hurricanes never cross the equator. It acts as a force field.

It also affects snipers targeting over long distances (>1000 yards). The bullet is in the air long enough for the Earth to rotate underneath it. The shooter must aim slightly left or right to compensate for the planet moving the target.
    `.trim(),
        questions: [
            {
...
*   Option C: Fly over it. General Lucius Clay proposed an "Air Bridge." Critics said it was impossible. To feed 2 million people required 4,000 tons of supplies *per day*. Coal, flour, milk.

They built a rhythm. Planes landed every 3 minutes, 24 hours a day, at Tempelhof Airport. Pilots flew on instruments in bad weather. German civilians helped unload planes in record time.
At the peak (The Easter Parade), they delivered 12,941 tons in one day—more than the trains used to carry.

It wasn't just food. "The Candy Bomber" (Gail Halvorsen) dropped chocolate on tiny parachutes for the kids. This was a PR coup. It turned the Germans (former enemies) into friends and victims, and the Soviets into cruel jailers.

Stalin realized the blockade had failed. It was making NATO stronger. He lifted it in May 1949. The Airlift proved that logistics could be a weapon of war, winning a battle without firing a shot.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Definition/Classification",
...
1.  **Thermophiles:** Heat lovers. Found in Yellowstone's boiling geysers and deep-sea Hydrothermal Vents (120°C). Their proteins don't cook (denature) because they have extra sulfur bonds (disulfide bridges) acting like staples.
...
The champion is the **Tardigrade** (Water Bear). It is a "Poly-extremophile." It can survive boiling, freezing, varying radiation, and the vacuum of space.
Its trick is *Cryptobiosis*. It dries itself out into a lifeless "Tun." It replaces the water in its cells with a sugar glass.
In this state, it is indistinguishable from death. Add water 10 years later, and it reanimates.

The discovery of extremophiles birthed the field of Astrobiology. If life can survive in boiling acid on Earth, why not in the subsurface oceans of Enceladus?
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Contrast/Purpose",
...
Achebe’s revolution was stylistic. He wrote in English, but "Africanized" it. He infused the text with Igbo proverbs ("Proverbs are the palm-oil with which words are eaten"). He showed that the Igbo culture was complex, having its own justice system, religion, and philosophy long before the white man arrived.

It was not a paradise. He shows the harshness (twins were killed). But it was a functioning society.

The title (from Yeats) implies chaos. When the British arrive, they don't bring order; they bring disorder. They split the clan. The tragedy is that Okonkwo cannot adapt. He is a rigid traditionalist. When he kills a messenger and his people don't rise up, he realizes his world is dead. He hangs himself.

Achebe forced the West to see Africans as humans with history. He is the father of African Literature, proving that until the lions have their own historians, the history of the hunt will always glorify the hunter.
    `.trim(),
        questions: [
            {
...
How does it work?
1.  **Currency Appreciation:** You discover oil. You sell it to the world. Foreign currency floods in. This makes your local currency stronger. 2.  **Export Death:** A strong currency makes your *other* exports (cars, clothes, agriculture) expensive for foreigners to buy.
    *   If a Dutch tulip costs 1 Euro ($1), and the Euro rises to $2, now the tulip costs $2. Americans stop buying Dutch tulips.
    *   The manufacturing and farming sectors collapse. You become a "One-Trick Pony" economy. 3.  **Corruption:** The government doesn't need to tax the people (because it has oil money). If you don't tax people, you don't listen to them. Democracy weakens. Dictatorships thrive on oil (petrostates). 4.  **Volatility:** When the oil price crashes (as it always does), the economy has no other legs to stand on. Collapse follows.

To avoid this, countries like Norway built a "Sovereign Wealth Fund." They took the oil money and invested it abroad, keeping it out of the local economy to prevent inflation, saving it for the future. They cured the disease by hiding the medicine.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Cause",
        dominantSkill: "Factual Information",
        passage: `
...
The floor of the Pacific Ocean (Pacific Plate) is expanding at the center. This pushes the edges of the plate outward.
The Pacific Plate is crashing into the continents around it (North American, Eurasian plates).

Because the oceanic rock is dense (basalt) and the continental rock is light (granite), the ocean plate slides *under* the continent. This is subduction. As the plate sinks deep into the mantle:
1.  **Earthquakes:** The friction is immense. The plates lock and snap, causing mega-thrust quakes (like Japan 2011).
2.  **Volcanoes:** The sinking plate carries water. When it gets hot, the water boils out. This water lowers the melting point of the hot rocks above it (flux melting). Magma rises to the surface, punching through the continent to form volcanoes (like Mt. Fuji or Mt. Rainier).

It is a geologic factory. It destroys old crust and creates new mountains, constantly reshaping the rim of the Pacific basin.
    `.trim(),
        questions: [
            {
...
Conditions: High Temperature (400°C) and High Pressure (200 atm) with an Iron catalyst. The high pressure forces the gas molecules together. The catalyst weakens the bond.
It worked. Suddenly, we could make unlimited fertilizer.

The Impact:
Populations exploded. Today, 50% of the nitrogen in your body came from a Haber factory. Without it, the Earth could support only 4 billion people, not 8 billion.

The Dark Side:
1.  **War:** Ammonia is also used to make explosives (TNT). Haber helped Germany prolong WWI despite the blockade cutting off nitrate imports. 2.  **Pollution:** The excess fertilizer runs off fields into the ocean, creating "Dead Zones" (algal blooms) where nothing can live.

Haber is a tragic figure. A Jew who developed poison gas for Germany in WWI, he was later exiled by the Nazis. He saved billions from hunger and killed millions with weapons, the duality of modern chemistry.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Invention/Impact",
...
Intel engineer Ted Hoff looked at it and said, "This is too complex." He proposed a radical idea: Instead of 12 "hard-wired" chips (one for add, one for display, etc.), why not build **one** chip that can do *everything* if you give it the right instructions (software)?
...
It was tiny (fingernail size). It had 2,300 transistors. It was as powerful as the room-sized ENIAC from 1946. Crucially, it was *programmable*.
The same chip could run a calculator, a traffic light, or a washing machine. You didn't need to redesign the hardware; you just changed the code. This detached hardware from logic.
It launched the PC revolution. Moore's Law took over, doubling the transistor count every two years. Today's chips have billions of transistors, but they still follow the architecture of the little 4004—a universal brain waiting for software to tell it what to be.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Experiment/Application",
        dominantSkill: "Prose Summary",
        passage: `
...
**Phase 2:** He put the dogs in a "Shuttle Box." It had a low fence. To escape the shock, all the dog had to do was jump over the fence.
...
Seligman realized this applies to humans. If a person faces repeated trauma (abuse, failure, poverty) that they cannot control, their brain is rewired. They stop trying. Even when an opportunity to escape appears (a job, a lifeline), they don't take it. They believe "Nothing I do matters."

This creates a cycle of depression.
The cure is "Learned Optimism." Cognitive Behavioral Therapy (CBT) involves teaching the patient that their actions *do* have consequences, breaking the belief of powerlessness by small wins. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mystery/Discovery",
        dominantSkill: "Factual Information",
        passage: `
...
The energy was absurd. In 10 seconds, a GRB releases more energy than our Sun will produce in its entire 10-billion-year life. What causes them?
There are two types:
1.  **Long Bursts (>2 secs):** The death of a massive star (Hypernova). The core collapses into a black hole, shooting jets of energy out the poles at 99.9% light speed. We only see the GRB if the jet is pointed *directly at us* (like a sniper rifle). 2.  **Short Bursts (<2 secs):** The collision of two Neutron Stars. (This also creates Gold and Platinum).

Are they a threat? Yes.
If a GRB occurred in our Milky Way, pointed at Earth, it would strip our Ozone layer in seconds. Solar radiation would then kill all surface life.
Some scientists believe the Ordovician Extinction (450 mya) was caused by a GRB.

Fortunately, they are rare in our galaxy. Most occur in distant, chaotic galaxies. But they serve as a reminder that the universe is a shooting gallery. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Purpose",
        dominantSkill: "Negative Factual Information",
        passage: `
...
The *Terracotta Army* consists of 8,000 life-sized soldiers, 130 chariots, and 520 horses. Remarkably, no two faces are alike. originally, we thought they used a single mold. Scanning shows they used "modular production." They had standard types of ears, noses, and eyes, which craftsmen mixed and matched, then hand-carved details to create individual personalities.

They were not grey. They were originally painted in bright colors (red, blue, purple). The paint peeled off instantly when exposed to modern air (oxidation).
...
The tomb itself remains unopened. Ancient records say it has rivers of flowing mercury. Soil tests confirm high mercury levels. Archaeologists are afraid to open it—not because of curses, but because we lack the technology to preserve what's inside (like the paint) before it disintegrates.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Criteria",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
Categories:
1.  **Site:** Don't build on wetlands. Build near public transport (to reduce car use). 2.  **Water:** Use low-flow toilets. Collect rainwater for landscaping (Greywater).
3.  **Energy:** This is the big one. Use high-insulation windows (Triple Glazing). Use LED lights. Install solar panels.
4.  **Materials:** Use recycled steel. Use local wood (to reduce shipping emissions). 5.  **Indoor Quality:** Use non-toxic paints (Low VOC) so people don't breathe fumes.

Critiques:
Some argue LEED is "Greenwashing." You can get points for a bike rack, but still build a glass box in the desert that requires massive AC. A bike rack shouldn't offset bad physics.

However, it changed the market. It made "Green" cool and profitable. Tenants pay higher rent for LEED buildings because their utility bills are lower and the air is better. It moved sustainability from a hippie niche to a corporate requirement.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Motivation",
        dominantSkill: "Inference",
        passage: `
...
1.  **Religious:** True belief. People believed going on Crusade would wash away all their sins (Plenary Indulgence). It was a ticket to Heaven. 2.  **Political:** The Pope wanted to reunite the Church (split in 1054) and show he was the boss of all Kings.
3.  **Social:** Europe was violent. Knights were constantly fighting each other. The Pope wanted to export this violence. "Stop fighting your brothers; go fight the infidel." The First Crusade was the only "successful" one.
Despite terrible leadership, starvation, and no supply lines, they captured Jerusalem in 1099.
The victory was due to Muslim disunity. The local Sultans were fighting each other and ignored the "Franks" until it was too late. The Crusaders massacred the inhabitants of Jerusalem (Muslims and Jews). They established "Crusader States."
These states lasted 200 years but were secluded islands in a hostile sea. They relied on Italian merchants for supplies (Venice/Genoa), which kickstarted the trade that would eventually lead to the Renaissance. The Crusades failed to hold the Holy Land, but they succeeded in reconnecting Europe to the wider world.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Implication",
        dominantSkill: "Sentence Insertion",
        passage: `
...
The data was shocking. The expansion is *speeding up*. The farther away the galaxy, the faster it is running away.

There must be a force pushing the universe apart, overcoming gravity. We call it *Dark Energy*.
We don't know what it is. It seems to be a property of space itself. As space expands, more dark energy appears. It is a runaway feedback loop.
...
This implies a lonely future. Eventually, galaxies will be pushed apart so fast that light cannot cross the gap. The sky will go black. We will be alone in our galaxy.
This overturned the "Big Crunch" theory (that the universe would snap back). The universe will end in a "Big Freeze"—cold, dark, and empty. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Definition/Ethics",
        dominantSkill: "Factual Information",
        passage: `
...
2.  **Pluripotent:** Can become any body part (heart, nerve), but not placenta. (Embryonic Stem Cells).
...
The medical dream is to use Pluripotent cells to grow new organs. Paralyzed? Grow new nerves.
...
In 2006, Shinya Yamanaka solved this. He invented **iPS Cells** (Induced Pluripotent Stem Cells). He took a normal skin cell and added 4 genes (Yamanaka Factors) that "reset" the clock. The skin cell turned back into a Stem Cell.

This bypassed the ethical problem. No embryos needed.
It also solved rejection. You can use the patient's own skin to grow their own new heart. The body won't attack it. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Reaction/Style",
        dominantSkill: "Rhetorical Purpose",
        passage: `
...
His point: In America, the richest consumer buys the same thing as the poorest. "A Coke is a Coke," said Warhol. "Liz Taylor drinks Coke, and you can drink Coke, too."

He removed the "Artist's Hand."
Classically, the brushstroke is the signature of the genius.
Warhol used *Silk Screen Printing*. It is a mechanical process. He could churn out 50 Marilyns in a day. He called his studio "The Factory." He treated art as a product, like a soup can.

Critics called it "Selling Out." Warhol said, "Making money is art." Pop Art forced us to look at our visual environment. We are bombarded by ads and logos. Pop Art says: This *is* our landscape. It is not Nature anymore; it is Brand.
By repeating an image (Marilyn) over and over, he showed how celebrity works: the person disappears, and only the icon remains. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Resolution",
        dominantSkill: "Prose Summary",
        passage: `
...
2.  **Group Areas Act:** Split the land. Whites (15% of people) got 87% of the land (the best farming/cities). Blacks got the "Bantustans"—barren homelands. 3.  **Pass Laws:** Blacks could not enter "White areas" (cities) without a Pass Book showing they had a job there. If you forgot your pass, you went to jail.

Resistance was led by the ANC (African National Congress) and Nelson Mandela.
After the Sharpeville Massacre (1960), the ANC turned to armed struggle. Mandela was imprisoned for 27 years. The system collapsed due to two pressures:
1.  **Internal:** The townships (Soweto) became ungovernable due to constant protests.
2.  **External:** The world imposed sanctions. South Africa was banned from the Olympics and global banking. The economy tanked. In 1990, President F.W. de Klerk realized the game was up. He released Mandela.
They negotiated a transition to democracy.
In 1994, Mandela was elected President.
Instead of revenge, he set up the "Truth and Reconciliation Commission" (TRC). Victims told their stories, and perpetrators got amnesty if they confessed. It wasn't perfect Justice, but it bought Peace.
    `.trim(),
        questions: [
            {
...
2.  **Calculability:** Quantity equals Quality. "The Big Mac." We want *more* for *less*. We assume a 500-page book is better than a 200-page one. GPA scores measure "student value" by a number.
3.  **Predictability:** No surprises. A Big Mac tastes the same in Paris as in Peoria. In movies, we prefer sequels and formulaic plots because we know what we are getting.
4.  **Control:** Replacing humans with non-human technology. Soda fountains that shut off automatically. Scantron tests.

The result is "The Irrationality of Rationality." By trying to be hyper-efficient, we create dehumanizing systems.
Efficient farming (factory farms) creates bad food.
Efficient travel (package tours) destroys the adventure.
Ritzer warns we are trapping ourselves in an "Iron Cage" of bureaucracy where creativity and humanity are squeezed out by the algorithm. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Process/Trace",
        dominantSkill: "Factual Information",
        passage: `
...
Normal Osmosis: Imagine a tank with a semi-permeable membrane in the middle. Salt water on the left, fresh water on the right.
...
To do this, we must apply pressure—massive pressure (1000 psi). We use pumps to smash the salt water against the membrane.
...
Problems:
1.  **Energy:** Pumping to 1000 psi takes huge electricity. It is expensive. 2.  **Brine:** You create tons of toxic sludge (brine). If you dump it back in the ocean, it sinks (it's heavy) and kills sea life.

Countries like Israel and Saudi Arabia rely on RO for 50%+ of their water. The challenge is to power these plants with solar energy to make them sustainable.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Classification/Nuance",
        dominantSkill: "Vocabulary in Context",
        passage: `
Symbiosis means "living together." It is not always friendly. It is a spectrum of interactions between species.

1.  **Mutualism (+/+):** Both benefit.
    Example: Clownfish and Anemone. The Anemone stings predators to protect the fish. The fish poop feeds the Anemone. Example: Your Gut Bacteria (see Batch 12).
...
2.  **Commensalism (+/0):** One benefits, the other doesn't care.
    ...
    example: Birds nesting in a tree. 3.  **Parasitism (+/-):** One benefits, the other is harmed.
...
The lines are blurry. The Oxpecker bird eats ticks off a Rhino. (Mutualism).
...
Evolutionary theory ("The Red Queen Hypothesis") suggests parasites drive evolution. The host must constantly evolve defenses, and the parasite must evolve offenses, just to stay in the same place. Sex itself may have evolved as a way to shuffle gene decks to stay one step ahead of parasites.
    `.trim(),
        questions: [
            {
