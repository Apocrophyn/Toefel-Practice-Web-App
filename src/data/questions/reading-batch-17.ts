...
export const batch17Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Comparison/Experiment",
...
Finally, you reach the limit ("Breakaway Point"). The box lurches forward. Now the box is sliding. You are fighting **Kinetic Friction**.
Crucially, Kinetic Friction is *weaker* than Static Friction.
Once it is moving, it is easier to keep moving. This is because the bumps don't have time to fully settle into each other; they skip over the top.
...
It keeps the tire in the *Static* zone (grip). Static grip is stronger than sliding grip. You stop faster and can still steer. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Assessment",
...
She started as a low-ranking concubine. She rose to power by producing the Emperor's only son. When the Emperor died (1861), she staged a coup and ruled as Regent "from behind the curtain" for 47 years. She faced an impossible situation. China was being carved up by foreign powers (Opium Wars) and torn apart by internal rebellion (Taiping Rebellion).
She supported the "Self-Strengthening Movement"—modernizing the army and building railroads—but she was cautious. She feared that too much Westernization would destroy the Manchu identity. Her biggest mistake was the *Boxer Rebellion* (1900). A peasant movement attacked foreigners. Cixi, hoping to drive the foreigners out, supported the Boxers.
It backfired. The Eight-Nation Alliance invaded Beijing. Cixi had to flee the Forbidden City dressed as a peasant. China was forced to pay a massive indemnity.
In her final years, Cixi ironically became a radical reformer. She abolished foot binding, revamped the education system, and promised a Constitution. She died in 1908 (one day after the Emperor... suspiciously). The Dynasty fell three years later (1911), not because she did nothing, but perhaps because she tried to do too much, too late.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Analogy",
...
*   The Fungus gives the Tree minerals (Phosphorus/Nitrogen) that it mines from the soil. But the fungus connects *different* trees together.
Dr. Suzanne Simard discovered that trees use this network to communicate.
*   **Resource Sharing:** An old "Mother Tree" (large, lots of sun) sends excess sugar to saplings growing in the shade. Without this lifeline, the babies would die.
*   **Warning Systems:** If a tree is attacked by aphids, it sends chemical signals through the fungus. Neighbors pick up the signal and start producing toxins *before* the aphids arrive. Cross-species sharing also occurs. Birch trees in summer send food to Fir trees. In winter (when Birch have no leaves), the Fir sends food back.
This challenges the Darwinian view of the forest as a purely competitive arena ("survival of the fittest"). It suggests the forest acts like a single super-organism, cooperating to ensure collective survival. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Style/Function",
...
We read Mina’s letters. We read Dr. Seward’s asylum notes. This creates suspense via *limited perspective*. Jonathan doesn't know what the reader knows. We want to scream "Get out!" but he can't hear us.

Also, the "Found Footage" effect.
In *Frankenstein* (Mary Shelley), the story is a letter from Captain Walton to his sister. He found a dying Victor Frankenstein on the ice. Victor tells his story. The monster tells Victor his story. It is a Russian Doll of narratives.

Modern versions include *World War Z* (oral history interviews) or *The Martian* (video logs). The format works because it is subjective. It highlights that truth is fragmented; everyone sees a different part of the monster. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Debate",
...
By the time you read the news, it is too late. The price has moved. Three forms of EMH:
...
3.  **Strong:** Even *insider* information is priced in. (The market is psychic). Implication:
...
Therefore, you should just buy the whole market (Index Funds) and hold. Critique:
...
Behavioral Economics argues that humans are emotional (fear/greed), so prices effectively are often *wrong*. Finding these errors is how Buffett gets rich. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Classification/Application",
        dominantSkill: "Factual Information",
        passage: `
...
**The Scale:**
1.  **Talc:** Baby powder. Scratched by a fingernail. 2.  **Gypsum:** Drywall. Use fingernail.
3.  **Calcite:** Scratched by a copper coin.
4.  **Fluorite:**
5.  **Apatite:** Scratched by a knife/glass.
6.  **Orthoclase Feldspar:** Scratches glass. (Dust is mostly feldspar/silica, which is hardness 7. This is why you shouldn't wipe a car with a dry cloth; the dust scratches the paint). 7.  **Quartz:** Common sand.
8.  **Topaz:**
9.  **Corundum:** Ruby/Sapphire.
10. **Diamond:** Only clarity scratches a diamond. Note the jump. Corundum (9) is twice as hard as Topaz (8).
But Diamond (10) is **4x** harder than Corundum. The gap between 9 and 10 is huge. Geologists use this in the field. If you find a mystery white rock:
...
*   **Tail:** Hydrophobic (Hates water, Loves oil). Long carbon chain. When you wash:
...
3.  They form a sphere called a *Micelle*. The grease is trapped inside the sphere.
    The outside of the sphere is water-loving.

So, the water can now promote the sphere and wash it away. Soap acts as an *Emulsifier*, bridging the gap between the two worlds.

Detergents work the same way but are synthetic (from petroleum). Unlike soap, they don't form "scum" in hard water (calcium). Soap has saved more lives than penicillin by simply physically removing pathogens from our skin.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Innovation/Comparison",
...
*   Europeans used *Parchment* (animal skin). It was durable but wildly expensive (one Bible required 300 sheep skins). *   Chinese used Bamboo slips (heavy) or Silk (expensive).
...
He dipped a screen into the water, lifting a thin layer of fibers. He dried the sheet.

Result: A material that was light, foldable, and cheap. Using garbage to preserve wisdom.

The secret was guarded for centuries.
In 751 AD, at the Battle of Talas, the Abbasid Caliphate (Arabs) captured Chinese papermakers. The technology spread to Baghdad (Golden Age of Islam), then via Spain to Europe.
By the time Gutenberg arrived (1450), paper mills were ready to feed his press. Without cheap paper, the printing press would have been useless (you can't print mass books on sheepskin). Cai Lun is arguably the most influential inventor in history alongside Gutenberg.
    `.trim(),
        questions: [
            {
...
2.  **Interpretation:** If we see ambiguous data, we twist it to fit.
    Example: A sports fan sees a referee call. If it hurts his team, he sees "Corruption." If it helps his team, he sees "Justice." Same call. 3.  **Memory:** We remember the hits and forget the misses. A psychic predicts 10 things. 1 happens. We say "Wow!" We forget the 9 failures. This bias protects our Ego. Being wrong feels physically painful (Cognitive Dissonance).
It explains political polarization. Two people can watch the same news clip and draw opposite conclusions. Francis Bacon (founder of the Scientific Method) warned about this in 1620.
Science is the only tool we have to fight it. Science demands we try to *falsify* our own theory. We must look for the Black Swan. If we don't, we are just telling ourselves comfortable lies.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Classification/Cycle",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
The Orion Nebula.
Huge clouds of Hydrogen. Violent young stars born inside light up the gas (ionize it), making it glow pink/red. Gravity pulls the dust together. Clumps form. Pressure rises. Fusion ignites. A star is born.

**2. Reflection Nebulae:**
The Pleiades.
Blue and ghostly. The dust reflects the light of nearby stars (like smoke reflecting a flashlight). **3. Planetary Nebulae (Graveyards):**
The Ring Nebula.
Misleading name (nothing to do with planets).
When a Sun-like star dies, it gently puffs off its outer layers. The core remains as a White Dwarf. The gas glows in a colorful expanding ring. **4. Supernova Remnants:**
The Crab Nebula.
Violent death. Massive star explodes. The debris is blasted out at 10% light speed.

This is the "Galactic Recycling" system. The dead stars enrich the clouds with heavy metals (created in their cores). The new stars (and their planets) are formed from this enriched dust. The iron in your blood came from a nebula.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Implication",
        dominantSkill: "Prose Summary",
        passage: `
...
2.  **To Receive:** You cannot refuse a gift. (Refusing means war or rejecting the relationship). 3.  **To Reciprocate:** You must give back in the future.

The gift creates a social bond (Debt).
If I buy you lunch, you "owe" me. We are connected until you pay me back. If I just paid you cash for a service, the transaction is over. We are strangers again.
...
If I give you a gift so big you can *never* repay it (e.g., the Potlatch Chief giving away a mountain of blankets), I have defeated you. I have established dominance. You are permanently in my debt aka my subordinate.
Charity can be this way. The rich giver gets power; the poor receiver loses dignity. Mauss showed that generosity is often a form of power play.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Philosophy",
        dominantSkill: "Rhetorical Purpose",
        passage: `
...
Wright said No. "I want you to live *with* the waterfall, not just to look at it." He built the house directly *over* the falls.
He used cantilevers (huge horizontal trays) made of reinforced concrete that projected out over the water without columns below. The sound of water is everywhere in the house.
...
Functionally, it was a nightmare. The roof leaked. The cantilevers sagged (they didn't put enough steel in, despite engineers warning Wright). It cost fortunes to repair.
But aesthetically, it is the greatest house of the 20th century. It proved that modernism didn't have to be a cold glass box (Bauhaus); it could be romantic and part of nature.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Contrast",
        dominantSkill: "Sentence Insertion",
        passage: `
...
The soldiers refused and joined the crowd. The Tsar abdicated. The 300-year Romanov dynasty ended in a week.
...
They were a small, disciplined party. They infiltrated the "Soviets" (worker councils).
...
This triggered the *Russian Civil War* (Reds vs. Whites). The Bolsheviks killed the Tsar and his family. They established the USSR as a totalitarian state.
February was a spontaneous uprising for freedom. October was a calculated takeover for ideology. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Principle/Paradox",
        dominantSkill: "Factual Information",
        passage: `
...
The Buoyant Force (upward push) is equal to the **Weight of the Fluid Displaced**. If I push a beach ball under water, it pushes away 5 lbs of water. The water pushes back with 5 lbs of force. Since the ball weighs almost nothing, it shoots up.
...
Therefore, the ocean pushes up with 50,000 tons of force. As long as the total weight of the Steel + Cargo is less than 50,000 tons, it floats.

If you poke a hole in the hull (Titanic), water rushes in. The air escapes.
The ship loses its volume. It displaces less water. The buoyant force drops. The weight remains the same. The ship sinks.
Submarines control this deliberately. ballast tanks fill with water to sink (dive) and pump air in to rise. `.trim(),
        questions: [
            {
...
Prions are misfolded proteins in the brain. Normal protein (PrP-C) = Alpha Helix shape (Good).
...
*   **Kuru:** Fore tribe in PNG ate the brains of ancestors (cannibalism). *   **Creutzfeldt-Jakob Disease (CJD):** Human version.

Prions are terrifying because they are indestructible.
You can boil them, soak them in formaldehyde, or blast them with radiation. They don't die (because they aren't alive). Prusiner was laughed at for years ("Biology Dogma says you need DNA!"). He won the Nobel Prize in 1997. Prions show that information can be transmitted by shape alone, not just by genetic code. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Context/Provocation",
        dominantSkill: "Inference",
        passage: `
...
It mocked authority, tradition, and the art market. They wrote nonsense poems. They wore cardboard costumes.

Marcel Duchamp is the icon.
In 1917, he submitted a porcelain urinal to an art exhibition. He signed it "R. Mutt" and titled it *Fountain*. The judges hid it.
...
Dada destroyed the idea that art must be a craft. It paved the way for Conceptual Art. The movement self-destructed in 1922. As soon as Dada became "accepted" by the public, it had to die, because it existed only to offend. It then morphed into Surrealism. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Correction/History",
        dominantSkill: "Factual Information",
        passage: `
...
1.  **Qin Dynasty (221 BC):** The First Emperor linked existing earthen walls. These were mounds of rammed earth. Little survives today.
2.  **Han Dynasty:** Extended it west to protect the Silk Road. They used reeds and gravel.
3.  **Ming Dynasty (1368-1644):** This is the wall you see on postcards. After the Mongols were expelled, the Ming wanted to ensure they never returned.
...
Smoke signals (wolf dung smoke) could send a message ("Invaders!") from the border to Beijing in hours. It was also a Customs border to tax trade.

Did it work?
No. The Mongols (Genghis Khan) went around it.
The Manchus (Qing) were let through the gates by a traitor general.
Psychologically, it represents the Chinese desire for order and separation from the "Barbarians." But historically, walls rarely stop a determined enemy.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Concept/Importance",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
3.  **Third Place:** The Pub, the Cafe, the Barber Shop, the Main Street Park. Characteristics of a Third Place:
...
Oldenburg warned that America is losing its Third Places. Suburban sprawl (Zoning) separates houses from shops. You have to drive everywhere.
We moved from the "Front Porch" (social) to the "Back Deck" (private).
We watch TV alone instead of going to the pub.

The result is loneliness and correct polarization. Third Places are the "Living Room of Society." They are where democracy happens. Steps are taken to rebuild them (Starbucks tries to *be* a Third Place, but it is corporate). Real Third Places grow organically, not by design.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Case Study/Phenomenon",
...
Wrong. It was **Aeroelastic Flutter** (Resonance). Every object has a "Natural Frequency" (like a wine glass).
The bridge's deck was solid (not a truss). It acted like an airplane wing.
The wind hit it, causing it to twist slightly.
This twist changed the aerodynamics, catching more wind, which pushed it back. The wind fed energy into the bridge *at the exact right rhythm* (like pushing a child on a swing).
The amplitude grew and grew until the steel snapped.

Lesson Learned:
Modern suspension bridges use **open trusses** (so wind blows *through*, not against). They use fairings (shapes to disrupt wind).
This disaster changed Civil Engineering from Static (forces) to Dynamic (vibrations). `.trim(),
        questions: [
            {
...
**Dinosaur traits:**
*   Teeth (Birds have beaks). *   Long bony tail (Birds have a stump).
*   Claws on wings.
*   Solid bones.

**Bird traits:**
*   Flight Feathers (asymmetrical). *   Wishbone (furcula).

It proved birds evolved from small, meat-eating dinosaurs (Theropods, like Velociraptor).
Modern discoveries in China (Liaoning) confirm this. We found Velociraptor cousins covered in fuzz/feathers. *T. rex* might have had feathers as a baby.

Why feathers?
Originally for warmth (insulation).
Then for display (sexual selection).
Finally for flight (exaptation). Dinosaurs didn't go extinct. You eat one for Thanksgiving.
    `.trim(),
        questions: [
            {
