...
export const batch13Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Definition/Phenomenon",
...
The boundary of no return is called the *Event Horizon*. It is not a solid surface; it is a mathematical point in space. Once you cross it, all paths lead inward. To escape would require moving backwards in time.

If you fell into a stellar-mass black hole, you would experience *Spaghettification*. Gravity gets stronger the closer you are to the center.
...
At the center lies the *Singularity*. Here, matter is crushed to infinite density and zero volume. The laws of physics (General Relativity) break down. We simply don't know what happens there. It is a divide by zero error in the universe's code. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Military Strategy",
...
Shaka introduced the *Iklwa*. This was a short stabbing spear. It forced his warriors to fight close-quarters, hand-to-hand. He also introduced the tall cowhide shield to hook the enemy's shield aside.
...
He organized the army into the "Buffalo Horns" formation. 1.  **The Chest:** The main force attacks the center.
2.  **The Horns:** Fast runners flank the enemy on both sides to encircle them.
3.  **The Loins:** Reserves wait behind the chest.

This total war machine crushed neighbors. The resulting chaos was the *Mfecane* ("The Crushing"). Displaced tribes fled Shaka, attacking other tribes in a domino effect that depopulated vast regions.

While Shaka was a brilliant general, he was a brutal tyrant who was eventually assassinated by his half-brothers. However, he created a unified Zulu nation that was strong enough, decades later, to defeat the British Empire at the Battle of Isandlwana.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution-Fail",
        dominantSkill: "Cause and Effect",
        passage: `
...
They heard about a giant toad from South America that ate beetles. In 1935, they imported 102 toads and released them in Queensland.

It was a disaster on multiple levels.
1.  **Wrong Habitat:** The beetles lived high on the cane stalks. The toads couldn't climb. They never met. The toads didn't eat the beetles. 2.  **Reproduction:** The toads bred explosively. A female lays 30,000 eggs at a time. Without natural predators, their population hit 200 million.
...
The toads are now spreading west across the continent, an unstoppable "grey wave," wiping out native predators. Scientists hope that evolution will intervene. Some snakes are evolving smaller heads (so they can't eat big toads) or learning to avoid them. The lesson remains: ecosystems are complex web; pulling one string (introducing a species) often unravels the whole knot.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Theme",
...
**Jules Verne** (*20,000 Leagues Under the Sea*, *Around the World in 80 Days*) was the optimist. He was an engineer at heart. He cared about *how* it worked. He did the math for the moon gun. He described the technology of the submarine.
His stories were about human adventure and mastery over nature. Science was the hero.

**H.G. Wells** (*The War of the Worlds*, *The Time Machine*) was the pessimist/sociologist. He didn't care how the Time Machine worked; he cared about *where* it went. He used sci-fi to critique society.
...
Verne hated Wells' work. He said, "I make use of physics. He invents. I go to the moon in a cannonball. He goes to Mars in an airship, which he constructs of a metal that does away with the law of gravitation. That's all very pretty, but show me this metal. Let him produce it." Verne predicted the submarine and the helicopter. Wells predicted the tank and the atomic bomb. Verne gave us the gadgets; Wells gave us the anxiety.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mechanism/Analogy",
...
A Blockchain is a "Distributed Ledger." Imagine a Google Doc that everyone can read, but no one can delete.
...
3.  The winner adds the Block to the chain of previous blocks. 4.  Everyone updates their copy of the ledger.

It is secure because of the "Chain." Each block contains a digital fingerprint (Hash) of the block before it. If a hacker tries to change a record in 2015, it changes the fingerprint. That breaks the link to 2016, which breaks 2017... The whole chain collapses. The network sees the broken chain and rejects it.

To hack it, you would need to control 51% of all the computing power in the world simultaneously. This "Trustless" system allows strangers to trade value without a middleman.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Utilization",
        dominantSkill: "Factual Information",
        passage: `
...
**P-Waves (Primary Waves):** These are longitudinal (compressional). They move like a slinky being pushed. They push and pull rock.
They are the *fastest* waves (6 km/s). They arrive first.
Crucially, they can travel through solids *and* liquids.

**S-Waves (Secondary Waves):** These are transverse (shear). They move like a rope being whipped up and down. They shake the ground sideways.
...
In the early 20th century, scientists noticed that P-waves went straight through the Earth, but S-waves disappeared on the other side (The S-Wave Shadow Zone). The only explanation: The center of the Earth is liquid.
The S-waves hit the liquid Outer Core and stopped. The P-waves hit it and refracted (bent).

By measuring the time gap between the P-Wave and S-Wave arrival, you can calculate the distance to the epicenter (like counting seconds between lightning and thunder). `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Process",
...
*   **Form V** is the Goldilocks crystal. It is shiny, snaps when you break it, and melts exactly at body temperature (34°C). The goal of the chocolatier is to force all the fat molecules to line up in Form V. This process is called *Tempering*.
...
2.  **Cool:** Cool it to 27°C. This allows both Form IV (bad) and Form V (good) crystals to form. It is now a mix.
3.  **Cheating:** Re-heat it slightly to 31°C.
Crucially, 31°C is hot enough to melt the bad Form IV crystals, but cool enough that the good Form V crystals survive. Now you have a liquid with only good seed crystals floating in it. When you cool it down completely, the rest of the chocolate uses those seeds as a template and crystallizes into perfect glossy chocolate.

If you skip this (Untempered chocolate), the cocoa butter separates. It rises to the surface as ugly white streaks called "Bloom," and the texture is crumbly. `.trim(),
        questions: [
            {
...
The process was dangerous and difficult. 1.  Take a silver-plated copper sheet.
...
4.  Develop it over hot Mercury fumes (highly toxic). The result was a unique positive image on metal. It was incredibly sharp.
However, it had downsides:
*   It was a mirror image (reversed).
*   It was a "one-off." There was no negative, so you couldn't make copies. To get a copy, you had to take a photo of the photo. Simultaneously, in England, William Henry Fox Talbot invented the *Calotype*, which used paper negatives. It was fuzzy, but reproducable.

Daguerre won the PR war initially. The French government bought the patent and gave it "free to the world" (except England). This caused "Daguerreotypomania." Suddenly, regular people could see what their ancestors looked like. History became visual.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Experiment/Trend",
        dominantSkill: "Inference",
        passage: `
...
Memory does not fade linearly. It decays exponentially. *   20 minutes after learning: He forgot 40%.
*   1 hour later: He forgot 60%.
*   1 day later: He retained only 33%.
Most forgetting happens immediately after learning.

However, he found a fix: *Spaced Repetition*. If he reviewed the material just as he was about to forget it, the decay curve flattened.
Review 1 (Day 1): Restores memory to 100%.
Review 2 (Day 3): The forgetting is slower now.
Review 3 (Day 10): It sticks.

To memorize effectively, you shouldn't cram (massed practice). You should space it out. Spacing effect suggests that struggling to retrieve the memory strengthens the neural pathway.

This research led to the "Primacy and Recency Effect." We remember the first things in a list (Primacy) and the last things (Recency). We forget the middle. Ebbinghaus turned the vague art of studying into a measurable science.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Method",
        dominantSkill: "Prose Summary",
        passage: `
...
This method relies on luck. We need the solar system to be aligned edge-on to Earth. If the planet passes *in front* of the star (transits), it blocks a tiny fraction of the starlight.
...
It looks for a dip. *   The dip must be periodic (e.g., every 365 days) -> telling us the Orbital Period (Year).
...
If we have Size + Mass = Density. Density tells us if it is a Gas Giant or a Rocky World.

Kepler found thousands of planets. It proved that planets are common; most stars have them. It revolutionized our place in the universe, showing that solar systems are the rule, not the exception.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Definition",
...
She defined "Dirt" as "Matter out of place." Soil in the garden is not dirty. Soil on your dinner plate is dirty.
...
Things that cross boundaries or are hybrids are dangerous/taboo. In Leviticus:
*   Land animals should have hooves and eat grass (Cows). Clean.
*   Sea animals should have fins and scales (Fish). Clean.
*   Pigs have hooves but don't eat grass (they are omnivores). They are hybrids. Dirty. *   Lobsters live in the sea but climb like spiders (no fins). Dirty.

They defy the classification system. They are cognitive monsters.

Douglas argued that rituals of cleaning are not just about scrubbing; they are about restoring order to the universe. By rejecting the "impure," the society defines its boundaries and reinforces its identity. Taboo is the fence around the social order.
    `.trim(),
        questions: [
            {
...
Before the Bauhaus, "Art" meant painting/sculpture, and "Craft" meant making chairs/kettles. Gropius erased the line. He believed an artist could design a teapot, and it should be mass-produced in a factory.
...
*   Simple geometric shapes and primary colors. Marcel Breuer designed the "Wassily Chair" using bent steel tubes (like bicycle handlebars). It was light, cheap, and strong.
Marianne Brandt designed teapots that looked like industrial machines.

The Nazis hated the Bauhaus. They saw it as "degenerate" and communist because it rejected German tradition. They closed the school in 1933.

The irony is that this persecution spread the style. The faculty (Gropius, Mies van der Rohe) fled to America. They became heads of architecture at Harvard and Chicago. They built the glass skyscrapers that define the American skyline. The curvy, decorative Victorian world was replaced by the square, functional Bauhaus world.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Conflict",
        dominantSkill: "Negative Factual Information",
        passage: `
...
To fix this, the British East India Company started smuggling *Opium* (grown in India) into China. It was illegal, but profitable. By 1830, millions of Chinese were addicted. The trade balance flipped; silver flowed out of China.

The Chinese Emperor appointed Commissioner Lin Zexu to stop it. Lin was incorruptible. He confiscated 20,000 chests of British opium and dissolved it in lime in the sea. He wrote a letter to Queen Victoria asking her to stop the drug traffic. Britain responded with war. They framed it as a defense of "Free Trade" and "Property Rights" (the destroyed opium).
The *First Opium War* (1839-42) was a massacre. The British iron steamshine *Nemesis* destroyed the wooden Chinese junks.

The resulting *Treaty of Nanking* was the first "Unequal Treaty." 1.  China had to pay for the destroyed opium.
...
This began China's "Century of Humiliation." It shattered the image of Chinese superiority and paved the way for the collapse of the imperial system in 1911.
    `.trim(),
        questions: [
            {
...
A wave doesn't have a specific location; it is spread out. The "Probability Wave" describes where the electron *might* be.
...
This is not just theory; it is why the Sun shines. In the Sun, protons try to fuse. But protons are both positive. They repel each other (Coulomb Barrier).
...
We use it in technology. Flash Drives (SSD) use tunneling to trap electrons in memory cells to store data.
...
It is a reminder that the solid rules of our macroscopic world are just statistical averages of the ghostly, probabilistic quantum world. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Concept/Mechanism",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
Viruses need hosts to spread. If I am infected, I might pass it to 2 people ($R_0 = 2$).
If everyone around me is vaccinated, the virus hits a "dead end." It cannot jump. The chain of transmission is broken.

This protects the vulnerable—babies, chemo patients, the elderly—who *cannot* be vaccinated. They rely on the "Herd" to be a shield. The threshold depends on contagiousness.
...
If the rate drops below the threshold (due to hesitancy), the holes in the shield get big enough for the virus to find the vulnerable. Outbreaks return.

Smallpox is the only human disease we have eradicated completely (1980). We did it through "Ring Vaccination"—finding cases and vaccinating everyone in a ring around them until the virus had nowhere left to go. It proved that biology is a numbers game.
    `.trim(),
        questions: [
            {
...
**Linear Perspective** (invented by Brunelleschi) is a mathematical system. It uses a "Vanishing Point" on the horizon. Parallel lines converge at this point.
...
Artists like Michelangelo and Da Vinci studied anatomy by dissecting corpses. They painted muscles, veins, and weight.
Even religious figures (Mary, Jesus) were painted as real humans with emotions, set in real landscapes under blue skies.

This secularization of art meant that a portrait of a rich merchant (Mona Lisa) became as valuable as an icon of a Saint. The individual ego emerged. Artists began signing their work (Medieval artists were anonymous). Art became a window into the natural world, rather than a door to the super-natural.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Regulation",
        dominantSkill: "Inference",
        passage: `
...
1.  **Lifeboats:** The Titanic carried boats for only 1,178 people (half the passengers). *According to the law* of 1894, this was legal! The law based lifeboat capacity on the *tonnage* of the ship, not the number of humans. The law was written for smaller ships 20 years earlier. It hadn't caught up to the super-liners (Cultural Lag).
2.  **Radio:** The *Californian* was only 10 miles away and saw the flares. But its radio operator had gone to sleep. There was no 24-hour watch requirement. The aftermath was the SOLAS Treaty (Safety of Life at Sea), 1914.
...
*   **Radio:** 24-hour radio watch is mandatory. *   **Ice Patrol:** The International Ice Patrol was formed to monitor icebergs.

Today, maritime travel is incredibly safe because every rule in the book is written in the blood of the Titanic victims. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Historical Trend/Critique",
        dominantSkill: "Factual Information",
        passage: `
...
For most of human history, the "traditional" family was the *Extended Family*. Grandparents, aunts, and cousins lived together or next door. They shared childcare and resources. In an agricultural society, you needed the labor.

The Industrial Revolution broke this. Factories required mobility. You had to move to the city for a job. You couldn't take the whole clan. The family shrank to the core unit: The Nuclear Family. The 1950s economic boom in the US made this idealized model possible. One income could support a house and car.
...
It isolates the elderly in nursing homes and the children in daycares. Since the 1970s, the model has declined due to economic shifts (requiring two incomes) and changing values (divorce, cohabitation). We are seeing a return to multi-generational living (due to rent costs) and "Chosen Families" (friends networks), suggesting the Nuclear Family may have been a temporary blip.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mechanism/Proof",
        dominantSkill: "Sentence Insertion",
        passage: `
...
To work, GPS must account for Einstein's Theories of Relativity. 1.  **Special Relativity:** The satellites are moving fast (14,000 km/h). Moving clocks tick *slower* (Time Dilation). This slows the satellite clocks by 7 microseconds a day.
2.  **General Relativity:** The satellites are far from Earth's gravity. Clocks in weak gravity tick *faster*. This speeds them up by 45 microseconds a day.

Net result: The satellite clocks run fast by 38 microseconds per day (45 - 7).
38 microseconds = 11 kilometers of error. If engineers ignored Einstein, GPS would fail in minutes. You would be driving in the ocean.
The satellites have atomic clocks that are programmed to tick slightly slower to offset these relativistic effects perfectly. It is the only everyday technology that relies on the warping of spacetime to function.
    `.trim(),
        questions: [
            {
...
It started 50 million years ago with *Pakicetus* ("Pakistan Whale"). It looked like a wolf with hooves. It lived near rivers. We know it's a whale ancestor because of a unique bone structure in its inner ear (the involucrum) found only in cetaceans.

Next came *Ambulocetus* ("Walking Whale"). It looked like a furry crocodile. It had webbed feet and could walk on land and swim.

Then *Basilosaurus* (35 mya). It was fully aquatic, 60 feet long, and snake-like. Crucially, it still had tiny, useless hind legs protecting from its body. Vestigial limbs.
...
3.  **Sonar:** Developed Echolocation to hunt in dark water. Why go back? The ocean was an empty niche. The dinosaurs (marine reptiles) were dead. There was free food and no competition. The whales returned to the womb of life, but they brought their mammalian toolkit with them. `.trim(),
        questions: [
            {
