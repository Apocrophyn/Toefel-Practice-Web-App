...
export const batch19Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Principle/Limitation",
...
The force is proportional to the distance ($F = -kx$). The further you pull, the harder it snaps back. Galileo discovered the magic of the pendulum in a cathedral. He watched a chandelier swing. He timed it with his pulse.
He found that the *Period* (time for one swing) depends only on the **Length** of the string.
It does *not* depend on the Mass (weight). A heavy bob and a light bob swing at the same rhythm. It does *not* depend on the Amplitude (how wide the swing is), as long as the angle is small.
...
In reality, air resistance creates *Damping*. The energy is lost to heat. The swings get smaller and smaller until it stops. To keeps a clock running, you need a mechanism (weights/gears) to give it a tiny push every swing to fight damping.
Also, if the angle is too big (>15 degrees), the math breaks (it becomes chaotic). `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Fall",
...
Because they lived on a lake, they invented *Chinampas* ("Floating Gardens"). They wove reeds together and piled mud on top to create artificial islands.
...
They believed the Sun God (Huitzilopochtli) needed blood to fight the darkness every night. If they stopped sacrificing, the sun would die. This required constant war ("Flower Wars") to capture prisoners for the altar.
...
But he found the Tlaxcalans. He united the native enemies of the Aztecs. Also, Smallpox arrived with the Spanish. It killed the Emperor Cuitláhuac and 40% of the population.

The city fell in 1521. The Spanish drained the lake and built Mexico City on top. Today, the soft lakebed soil causes the modern city to sink inches every year. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Process/Function",
...
Crucially, the "Glymphatic System" turns on. The brain cells shrink, and cerebrospinal fluid washes through to flush out toxins (like Beta-Amyloid, which causes Alzheimer's). **REM (Dream Sleep):**
Rapid Eye Movement.
The brain is hyper-active. It looks awake on a scan.
But the body is paralyzed ("Atonia") so you don't act out your dreams. This is emotional/memory processing. The brain takes the day's memories and moves them from short-term (Hippocampus) to long-term storage (Cortex). It deletes the junk.

The cycle changes.
Early night: Mostly Deep Sleep (Physical fix).
Late night (morning): Mostly REM (Mental fix). If you wake up an hour early, you cut off your REM. You will be grumpy and forgetful.

Sleep deprivation is torture. Rats die after 2 weeks without sleep (faster than starvation). The brain effectively poisons itself.
    `.trim(),
        questions: [
            {
...
In Magical Realism, the magic is mundane. It is treated as a normal part of daily life. Example: In *100 Years*, a character (Remedios the Beauty) floats into the sky while folding sheets.
The family doesn't scream. They just complain that she took the expensive sheets with her. Or it rains for 4 years straight. No one panics; they just fix the roof.
...
Rational realism (European style) couldn't capture the "outsized" reality of the tropics. Paradoxically, by adding magic, he makes the political critique sharper. The "Banana Massacre" in the book (where the army kills strikers and erases the memory) feels surreal, but it successfully depicts the real gaslighting of authoritarian history. `.trim(),
        questions: [
            {
...
The car didn't just add to the horse-and-buggy industry; it annihilated it. The blacksmiths, whip-makers, and stable boys lost their jobs. This was the "Destruction." But the car created new jobs: mechanics, gas stations, road builders. This was the "Creation."
...
The Entrepreneur introduces an innovation (tech or method) that disrupts the status quo. This disruption creates a temporary monopoly (super-profits).
Eventually, competitors copy it, profits fall, and equilibrium returns until the next disruption.

Implication:
Trying to save dying industries (Bailouts) is bad. It stops progress. You are freezing the system in the past. To have iPhones, you must let Kodak and Nokia fail.
Pain is necessary for growth.
However, this is cold comfort to the blacksmith. This tension—efficiency vs. social stability—is the central conflict of modern economic policy.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Observation",
        dominantSkill: "Factual Information",
        passage: `
...
1.  **Kaibab Limestone (Top):** 270 million years old. Contains fossils of sea shells and sharks.
    Conclusion: This desert was once a warm, shallow ocean. 2.  **Coconino Sandstone:** Below the limestone. Massive cross-bedded petrified dunes.
    Conclusion: Before the ocean, it was a giant Sahara-like desert.
3.  **Hermit Shale:** Mud/Silt with fern fossils.
    Conclusion: It was a swampy river delta. **The Great Unconformity:**
...
1.2 billion years are missing! Where did the rock go? It was eroded away before the sandstone was laid down. It is like tearing 100 pages out of the middle of the book.

The Canyon itself is young. The river only started cutting it about 6 million years ago. It carved through the ancient cake like a knife.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Innovation/Process",
        dominantSkill: "Inference",
        passage: `
...
He reacted a diamine with an acid. They fused to form a long strong chain (Polyamide). It was the first truly synthetic fiber (Rayon was made from wood pulp). Nylon was made from "coal, water, and air."
It was strong and elastic.
DuPont targeted the women's hosiery market (Silk stockings were expensive and ripped).
"Nylons" went on sale in 1940. They sold 64 million pairs in the first year. Then WWII started.
Nylon was drafted. All production went to the military.
Parachutes, ropes, tents, tires. Silk came from Japan (the enemy). We needed a domestic substitute. Nylon won the war.

After the war, the technology exploded.
Polyesters, Polyethylene, PVC.
Plastic is cheap, sterile, and durable.
Paradox: Its durability is its curse. A plastic bottle lasts 450 years. We built a disposable culture out of an indestructible material.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Project/Dilemma",
...
A Chain Reaction. The Challenge: Enrichment.
...
They built massive centrifuges at Oak Ridge, Tennessee. It consumed 10% of the US electricity supply. The Test: Trinity (July 1945).
New Mexico desert.
They imploded a Plutonium core.
It worked. Oppenheimer recalled the Hindu scripture: "Now I am become Death, the destroyer of worlds." The Choice:
...
Regardless, it ended the age of Total War and began the Cold War. `.trim(),
        questions: [
            {
...
1.  **Secure Attachment (60%):** Baby cries when Mom leaves, but is quickly soothed when she returns. Mom is a "Secure Base." Result: Independent, healthy adults.
2.  **Anxious-Resistant:** Baby is clingy. When Mom returns, the baby wants a hug but *also pushes her away*. They are angry. They don't trust she will stay.
    Result: Needy adults. 3.  **Avoidant:** Baby doesn't care when Mom leaves and ignores her when she returns. They have learned that crying doesn't work. They shut down needs.
    Result: Emotionally distant adults.

This proved that early childhood interactions wire the brain for future relationships. It is not about food. Harry Harlow showed that baby monkeys preferred a "Cloth Mother" (soft/warm) that gave no milk over a "Wire Mother" that gave milk. We need love more than calories.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Formula/Analysis",
        dominantSkill: "Prose Summary",
        passage: `
...
3.  **$n_e$:** Planets in the "Goldilocks Zone" (Habitable). (Maybe 1 in 5). 4.  **$f_l$:** Chance of Life starting. (Unknown).
...
7.  **$L$:** The big one. **Length of time** a civilization survives. If civilizations destroy themselves quickly (nuclear war/climate change) -> $L$ is small (100 years). Then $N = 0$. We are alone.
If civilizations survive for millions of years -> $L$ is big. Then $N$ is thousands. The galaxy is buzzing.

This is the *Fermi Paradox*: If the math says aliens should be everywhere, "Where is everybody?" Maybe we are the first.
Maybe there is a "Great Filter" that kills everyone before they get to space.
Maybe they are listening but following a "Prime Directive" not to talk to the primitives (us). `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Distinction/Cultural Context",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
People eat only to prevent death. It is shameful. It creates trauma. It is an act of desperation, not culture.
...
*   **Endocannibalism:** Eating your own group.
    ...
    It was an act of love. Leaving the body to rot in the cold ground was considered cruel and disrespectful. By eating them, they kept the spirit warm and within the community. (This stopped because it spread Kuru/Prions - Batch 17).
*   **Exocannibalism:** Eating enemies.
    The Aztecs or Fijian warriors.
    This is about power. By eating the heart of a brave enemy, you absorb his courage (Mana). It is the ultimate humiliation of the foe.

Western explorers often exaggerated these accounts (like Columbus and the "Caribs") to justify conquest. "They are savages, so we must civilize/enslave them." Modern anthropology argues it was rare, but definitely existed as a complex cultural practice, not just hunger.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Style/Symbolism",
...
Sharp angles. Zigzags. Sunbursts. Materials were shiny: Chrome, Glass, Aluminum, Bakelite.

The classic example is the **Chrysler Building** in New York.
The spire looks like a radiator grill or hubcaps.
The gargoyles are hood ornaments (Eagles). It celebrated the Automobile as a god.
...
It peaked during the Great Depression. It was Escapist. Hollywood cinemas were built as Art Deco palaces to let people dream.
By WWII, it looked too frivolous and expensive. It was replaced by the stark, severe International Style (Bauhaus). But for a brief moment, it captured the optimism of a world that thought technology would solve everything.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Uniqueness",
        dominantSkill: "Factual Information",
        passage: `
...
He played the empires against each other. He fought for Spain, then for France (when France abolished slavery), then against Britain. Napoleon seized power in France. He wanted slavery back. He sent an invasion fleet to Haiti. Toussaint was captured and died in a French prison.
...
The US (Thomas Jefferson) was terrified of a black republic inspiring their own slaves. They embargoed Haiti. France demanded a massive indemnity (reparations) for the "lost property" (slaves). Haiti spent 100 years paying it off, crippling its economy. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Application",
        dominantSkill: "Sentence Insertion",
        passage: `
...
He pulled the magnet **out**. The current needle jumped. He pushed it **in**. The needle jumped the other way.
...
This invention is the **Generator**. Every power plant today (Coal, Nuclear, Hydro) is just a fancy way to spin a magnet inside a coil of wire.
Steam spins the turbine -> Turbine spins magnet -> Magnet pushes electrons -> Lights on.

It also works in reverse: The **Motor**.
Put electricity into a wire in a magnetic field -> The wire moves. Faraday was uneducated (a bookbinder's apprentice). He didn't know math. He visualized "Field Lines"—invisible rubber bands filling space. Later, Maxwell turned these pictures into the equations that govern the modern world.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Strategy",
        dominantSkill: "Classification",
        passage: `
...
The Hoverfly (tasty) looks exactly like a Wasp (sting). Birds avoid the Hoverfly because they learned not to eat Wasps.
...
The Monarch Butterfly (toxic) and the Viceroy Butterfly (also toxic) look the same. Why?
...
If they share Pattern A, the bird learns faster. They share the cost of educating the predator. A third rare type is **Aggressive Mimicry**.
The predator mimics the harmless thing.
The Firefly "Femme Fatale."
Female *Photuris* fireflies mimic the flash pattern of female *Photinus* fireflies. The *Photinus* male comes looking for love, and the *Photuris* female eats him. `.trim(),
        questions: [
            {
...
The Melting Clocks. Hard objects (watches) become soft (cheese).
...
Dalí said, "I don't do drugs. I *am* drugs." René Magritte (Belgian) was different. He was quiet and logical.
*The Treachery of Images*.
A painting of a pipe with the words "Ceci n'est pas une pipe" (This is not a pipe).
It is true. You cannot smoke it. It is a *painting* of a pipe. He challenged the relationship between the object, the image, and the word.

Surrealism matters because it liberated art from logic. It allowed artists to explore the irrational, the nightmare, and the bizarre, influencing everything from advertising to music videos today.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Observation",
        dominantSkill: "Negative Factual Information",
        passage: `
...
He described:
1.  **Paper Money:** People trading burned bark for silk? Crazy. 2.  **Coal:** "Black stones that burn longer than wood." Unknown in Europe.
3.  **Post System:** The Khan had stations with fresh horses every 25 miles, allowing messages to fly across the empire.

He didn't mention tea, chopsticks, or the Great Wall (which was in ruins then, see Batch 17). This led some to doubt he ever went. But modern historians confirm his details on salt taxes and geography are accurate.

His book changed the world.
It inspired Christopher Columbus. Columbus carried a copy of Polo's book (with notes in the margin) when he sailed West in 1492. He was looking for Polo's "Cipangu" (Japan) and the Khan's court. He found America instead. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Metaphor",
        dominantSkill: "Prose Summary",
        passage: `
...
They blend with others to create a new alloy: "The American." Motto: *E Pluribus Unum* (Out of many, one).
...
Together, they form a picture. Motto: "Unity in Diversity."
...
Sociologists now suggest a third model: **The Salad Bowl**. You are mixed together (like lettuce and tomatoes). You touch, but you stay distinct. But the "Dressing" (Law/Constitution) covers everyone.
The debate continues as globalization increases migration. Is a nation a soup or a salad? `.trim(),
        questions: [
            {
...
Solution 1: **Sanitation.** Dr. William Gorgas drained the swamps and put screens on windows. He proved mosquitoes carried the disease. Once the bugs died, the work could start. Solution 2: **Locks.**
Instead of digging down to sea level, they decided to lift the ships *over* the mountains.
They dammed the Chagres River to create a massive artificial lake (Gatun Lake) 85 feet above sea level. The System:
...
4.  Ship enters locks on Pacific side. Water drains out. Ship lowers. The Canal is a bridge of water.
Crucially, it uses no pumps. The water form the lake does all the work (gravity).
However, each ship uses 52 million gallons of fresh water, which is flushed into the ocean. droughts now threaten the canal's capacity, as the lake level drops too low to float the big ships.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Adaptation",
        dominantSkill: "Inference",
        passage: `
...
Feet: 4 toes on front, 3 on back. Padded feet (like a dog) to walk on soft forest floor. Teeth: Low crowns for soft leaves.
...
Feet: The side toes disappeared. The middle toe became a single **Hoof**. This is a rigid spring. It makes the leg lighter and faster.
Teeth: "Hypsodont" (High Crowned). Grass has silica (sand) inside it. It wears teeth down like sandpaper.
The horse evolved teeth that keep erupting (growing) throughout life to compensate for the wear. The horse actually evolved in North America, spread to Asia, and then went extinct in America 10,000 years ago (Climate/Humans?). The Spanish brought them back in 1493, returning the horse to its evolutionary cradle.
    `.trim(),
        questions: [
            {
