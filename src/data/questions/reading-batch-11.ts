...
Enthalpy refers to heat content. Systems prefer to release heat (exothermic). A ball rolling down a hill releases potential energy; similarly, atoms prefer to bond in ways that release energy. A negative $\Delta H$ (releasing heat) is favorable.

Entropy refers to disorder or randomness. Systems prefer to become messy. A clean room naturally becomes dirty; it takes work to keep it clean. Smoke spreads out; it never gathers back into the wood. A positive $\Delta S$ (increasing disorder) is favorable.
...
Who wins? It depends on Temperature ($T$). The equation for Gibbs Free Energy is $\Delta G = \Delta H - T\Delta S$.
If $T$ is high, the Entropy term ($T\Delta S$) becomes dominant. The desire to be disordered overpowers the desire to stay cold. So, at high temperatures, Entropy wins and the ice melts. At low temperatures, Enthalpy wins and water freezes. The universe is a constant tug-of-war between the drive for low energy and the drive for high chaos.
    `.trim(),
        questions: [
            {
...
Technologically, the invention of the magnetic compass, the stern-post rudder, and watertight bulkheads made Chinese junks the most advanced ships in the world. They could carry massive loads.

Economically, a camel can carry 500 lbs. A ship can carry 500 *tons*. For heavy, bulk goods like ceramics (porcelain) and iron, land travel was impossibly expensive. You could only make a profit carrying light, high-value items like silk or spices on a camel. Ships allowed mass trade in everyday goods. "China" (dishes) became "china" because ships made it cheap enough to export globally.

The route connected China to India, the Persian Gulf, and East Africa. Admiral Zheng He's voyages in the 15th century were the zenith of this network. His "Treasure Ships" were 400 feet long.

However, the Ming Dynasty later banned private sea trade (Haijin) to fight piracy. This policy blunder left the ocean open for the Portuguese and Dutch to take over in the 16th century, leading to European dominance of the seas for the next 400 years.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Paradigm Shift/Mechanism",
...
The primary mechanism is *DNA Methylation*. A small chemical tag (methyl group) attaches to a gene. This acts like a switch. It turns the gene "Off." The gene is still there, but it is silenced.

Crucially, these tags can be added or removed by *environment* and *lifestyle*. Stress, diet, and toxins can alter your methylation patterns.
...
Most shockingly, these tags can be inherited. In the "Dutch Hunger Winter" study, women who were starved during WWII gave birth to babies who were prone to obesity and diabetes decades later. The famine had toggled their genes to "hoard calories." Even their grandchildren showed effects.

This suggests a Lamarckian twist to evolution: the experiences of the parents (famine, trauma) can leave a biological scar on the children. We are not just guardians of our DNA; we are its editors.
    `.trim(),
        questions: [
            {
...
Many, like Hemingway and F. Scott Fitzgerald, became expatriates in Paris. They felt America was puritanical and materialistic. Paris offered cheap wine, sexual freedom, and art.

Hemingway’s style—the "Iceberg Theory"—was a direct reaction to the war. Pre-war literature (like Victorian novels) was flowery and abstract, using words like "glory," "honor," and "sacred." The war proved these words were lies.
...
In *The Sun Also Rises*, the characters drink and travel, but never talk about their trauma. The silence is the point. They are "lost" not because they are wandering, but because the old moral compass—faith in God and Country—had been destroyed by mustard gas. They had to create a new code of conduct based on stoic endurance.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Definition/Analysis",
...
Real countries fall in the middle. The Nordic countries (Sweden, Norway) are low, around 0.25. They have high taxes and strong welfare states.
The United States is relatively high for a developed nation, around 0.48. Developing nations like South Africa or Brazil often exceed 0.60.

The Gini is derived from the *Lorenz Curve*. If you plot the cumulative percentage of the population against the cumulative percentage of income, a straight 45-degree line is perfect equality. The Lorenz curve bows underneath it. The Gini is the area of the gap between the straight line and the bowed curve. The bigger the belly of the curve, the higher the inequality.

Critics argue the Gini is flawed because it ignores wealth (assets like houses/stocks) and only measures income. A retired millionaire might have zero "income" but be rich. Despite this, it remains the primary tool for debating whether the gap between the rich and poor is growing to dangerous levels.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Process/Landscape",
...
Rivers carve "V-shaped" valleys. Glaciers carve "U-shaped" valleys. The ice fills the entire valley floor and sides, scouring it into a wide, steep-walled trough. Yosemite Valley is a classic U-shaped glacial trough.

The debris (rocks/sand) picked up by the glacier acts as the cutting tool. The glacier acts like a giant sheet of sandpaper. It polishes the bedrock (glacial polish) and scratches it (striations), which tell geologists the direction the ice moved.

When the glacier melts (retreats), it drops its load. This pile of unsorted rocks is called a *Moraine*. A "Terminal Moraine" marks the furthest point the glacier reached. Long Island, New York, is essentially a giant terminal moraine left by the Laurentide Ice Sheet 20,000 years ago.

If a U-shaped valley is close to the coast and gets flooded by the sea, it becomes a *Fjord*. These deep, narrow harbors (common in Norway) are the drowned ghosts of the Ice Age.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mechanism/Process",
        dominantSkill: "Factual Information",
        passage: `
...
A simple battery has two metal electrodes: an Anode (e.g., Zinc) and a Cathode (e.g., Copper), sitting in an electrolyte solution. The Zinc wants to get rid of electrons (oxidize) more than the Copper does.
...
When the electrons reach the Copper electrode, they grab Copper ions from the solution and plate them onto the solid metal (reduction). However, if positive Zinc ions build up on one side and negative electrons leave, the charge imbalance would stop the flow instantly. The solution is the *Salt Bridge*. It connects the two liquids. It allows ions to flow back and forth to balance the charge, completing the circuit.

When the Zinc is all dissolved, the battery is "dead." A *rechargeable* battery (Lithium-ion) works by using electricity to force the reaction in reverse, pushing the electrons back to the unstable side, ready to flow down the hill again.
    `.trim(),
        questions: [
            {
...
The breakthrough idea was *Packet Switching*. In a phone call, you "rent" a continuous line. If silence happens, the line is wasted.
...
The first node of ARPANET was installed at UCLA in 1969. The first message ever sent was "LO." (They tried to type "LOGIN," but the system crashed after two letters).

By the 1970s, universities linked up. They needed a common language. Vint Cerf and Bob Kahn invented *TCP/IP* (Transmission Control Protocol). This allowed different types of computers to talk to each other. It is the "handshake" of the internet.

It wasn't until 1989 that Tim Berners-Lee invented the *World Wide Web* (a way to organize information using hyperlinks). The Internet is the road; the Web is the trucks driving on it. But the indestructible road was built by the military to survive the apocalypse.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "theory/condition",
        dominantSkill: "Prose Summary",
        passage: `
...
low is a state of deep absorption in an activity. You lose track of time. You lose your sense of self (ego). The action and awareness merge.
...
*   If both match at a high level = **Flow**. A video game is a flow machine. It gets harder exactly as you get better. If it stayed easy, you'd quit.

Csikszentmihalyi found that Flow is autotelic (rewarding in itself). A painter enters flow not for the money, but for the act of painting. This challenges the idea that "leisure" is the goal of life. People report more flow at work than on vacation. The passive consumption of TV creates "apathy," the opposite of flow. Happiness, therefore, is an active state of mastery, not a passive state of pleasure.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Evidence",
        dominantSkill: "Inference",
        passage: `
...
The early universe was a hot, dense fog of plasma. As it expanded, it cooled. The light from that early fire should still be traveling through space, but stretched by expansion into invisible microwaves.

In 1964, two radio astronomers, Penzias and Wilson, built a sensitive antenna in New Jersey. They heard a persistent hiss. It came from everywhere, day and night. They thought it was pigeon poop on the antenna. They cleaned it. The hiss remained.

They had accidentally discovered the *Cosmic Microwave Background* (CMB). It is the afterglow of creation. It corresponds to a temperature of 2.7 Kelvin, exactly what the Big Bang math predicted.

This killed the Steady State theory. The universe had a beginning.

Later satellites (COBE, Planck) mapped this noise. It is not perfectly smooth. There are tiny fluctuations. These tiny clumps of higher density became the seeds that gravity pulled together to form the first galaxies. Without those imperfections in the baby universe, we would not exist.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Counter-Intuitive",
        dominantSkill: "Rhetorical Purpose",
        passage: `
...
In the 1960s, anthropologist Marshall Sahlins challenged this with his theory of the "Original Affluent Society." He studied modern foragers like the !Kung (Bushmen) of the Kalahari. He found they only worked 15-20 hours a week to meet their nutritional needs. The rest of the time they spent sleeping, gossiping, and playing.
...
If your wants are few and easily met, you are rich. The hunter-gatherers had no desire to hoard stuff because they were nomadic—carrying stuff is a burden.

However, critics note that while they had free time, they had high infant mortality and no medicine. Sahlins may have romanticized the "Noble Savage." Yet, the theory forces us to question if "Progress" has actually improved our quality of life or just increased our workload.
    `.trim(),
        questions: [
            {
...
The name comes from the French *béton brut*, meaning "raw concrete." It was about *Honesty*.

After WWII, Europe was in ruins. Architects wanted to rebuild society without the lies of the past. No more fake marble columns. No more decoration. They wanted to show the materials as they were. If a building was held up by concrete, you should see the concrete, rough textures and all.

It was also about *Socialism*. Concrete was cheap and democratic. Brutalism was used for public housing, universities, and government buildings. It was meant to project strength and permanence for the welfare state.

The style failed not because of the philosophy, but because of the weather. In rainy England, raw concrete stains and streaks. It looks depressing and dystopian (think *A Clockwork Orange*). It became a symbol of bureaucratic oppression rather than liberation. Today, however, it is seeing a hipster revival, appreciated for its sculptural power and "monumental" weight.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Anomaly",
        dominantSkill: "Factual Information",
        passage: `
...
It was uniquely terrifying because of its target. Normal flu kills the weak: the very young and the very old (a "U-shaped" curve). The 1918 flu killed the strong: healthy adults aged 20-40 (a "W-shaped" curve).

The cause was a "Cytokine Storm." The virus provoked an immune system reaction. The *stronger* your immune system, the stronger the reaction. The body attacked the virus so violently that it filled the lungs with fluid, drowning the patient. Young adults had the strongest immune systems, so they died fastest.

Why "Spanish"? Spain was neutral in WWI. The combatant nations (US, UK, Germany) censored the news to keep up morale. They didn't report the plague. Spain had a free press, so they reported it. The world assumed it started in Spain. In reality, it likely started in Kansas.

The movement of troops spread it globally. It killed faster often within 24 hours of first symptoms. It fundamentally created the modern public health system, but its lesson—that a virus travels as fast as humans do—remains our primary threat today.
    `.trim(),
        questions: [
            {
...
**N-Type Doping:** If we add Phosphorus (which has 5 electrons), there is one extra electron floating around. This electron is free to move. The material becomes Negative (N-type) and conducts current.

**P-Type Doping:** If we add Boron (which has 3 electrons), there is a hole (a missing electron). This "hole" acts like a positive charge. Electrons jump into the hole, leaving a new hole behind. The "hole" moves. The material becomes Positive (P-type).

The magic happens when you touch N-type and P-type together: a *P-N Junction*. Current can flow one way (forward), but not the other (reverse). It acts as a one-way valve (Diode).

By stacking them (N-P-N), you create a *Transistor*. You can use a small current in the middle to block or allow a huge current across the whole thing. It is a switch. This simple atomic sandwich is the bit (1 or 0) of every computer.
    `.trim(),
        questions: [
            {
...
**Bacteria** are life. They are single-celled organisms. They eat, they respire, they move, and they reproduce on their own (fission). They are complex machines with organelles. You can kill them with antibiotics (which break their machinery). Most are harmless or beneficial (gut flora); only a few cause disease.

**Viruses** are... ambiguous. They are *not* alive by the standard definition. They are just a snippet of genetic code (DNA or RNA) wrapped in a protein box. They cannot eat. They cannot reproduce on their own. They are "obligate parasites."

A virus is information waiting for a reader. It floats until it touches a cell. It injects its code. The cell reads the code and is hijacked. The cell stops its normal job and becomes a virus factory, churning out copies until it pops.

This explains why antibiotics don't work on the flu. You cannot "kill" a virus because it isn't alive. Antibiotics poison bacterial walls; viruses have no walls and no metabolism to poison. To stop a virus, you need antivirals (which gum up the copying mechanism) or vaccines (which teach the body to destroy the box before it opens).
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Style",
        dominantSkill: "Prose Summary",
        passage: `
...
They argued that perspective is a lie. We don't see objects from one fixed point; we move around them. Our mind creates a composite image of the front, back, and sides.

Cubism attempts to paint the "concept" of the object, not the "view." In a Cubist portrait, you might see the nose in profile but the eyes looking straight at you. You see the coffee cup from the side and the top simultaneously. It fractures the object into geometric planes (cubes).

They were influenced by Paul Cézanne and African masks. The movement evolved. "Analytical Cubism" (early) was grey and difficult to decipher—it looked like broken glass. "Synthetic Cubism" (later) introduced collage—sticking newspaper and wallpaper onto the canvas.

This was the first abstract art. It stated that a painting is not a mirror of reality; it is a reality in itself. It paved the way for pure abstraction (Mondrian, Pollock), proving that art didn't need to look like "things" to convey truth.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Context",
        dominantSkill: "Inference",
        passage: `
...
But that beep terrified America. It meant the Soviets were ahead. It resulted in the "Sputnik Crisis." The US public felt vulnerable. If they have a rocket powerful enough to go to space, they can nuke us.

The US government panicked. The result was massive investment.
1.  **NASA:** Formed in 1958 to organize the chaotic US efforts.
2.  **Education:** The NDEA (National Defense Education Act) poured billions into science and math education. If you learned calculus in the 1960s, it was because of Sputnik.

The race culminated in the Apollo Moon Landing (1969). Ironically, the moon was a strategic dead end. It had no military value. But the *prestige* was everything. By landing on the moon, the US proved its system (Capitalism/Democracy) was technologically superior to Communism.

Once the point was proved, the funding dried up. The Space Race ended not with a treaty, but with a handshake in orbit (Apollo-Soyuz, 1975), turning the cosmos from a battleground back into a frontier.
    `.trim(),
        questions: [
            {
...
Consider two teenagers smoking marijuana. Teen A (middle class, suburban) is caught by police. The officer calls his parents and lets him go with a warning ("Boys will be boys"). He is not labeled. He grows up to be a lawyer.
Teen B (poor, urban) is caught. He is arrested, charged, and labeled a "criminal" or "junkie."

Once the label is applied, it becomes a *Self-Fulfilling Prophecy*. Teen B is treated effectively as a criminal. He can't get a job. Respectable people shun him. His only friends are other "criminals." He is forced into secondary deviance (more crime) to survive. The system created the criminal.

This is the concept of "Master Status." The label overrides all other identities. You are no longer a "father" or "mechanic"; you are a "Felon."

Critics argue Labeling Theory ignores moral responsibility—murder is wrong regardless of the label. However, the theory was crucial in reforming juvenile justice, emphasizing diversion programs to avoid branding young people with permanent "scarlet letters."
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mechanism/Advantage",
        dominantSkill: "Factual Information",
        passage: `
...
**Levitation:** Powerful magnets on the track repel magnets on the train. (Recall that like poles repel). Ideally, superconductors are used (see Batch 8) to create strong enough fields.

**Propulsion:** The track itself is the motor. It is a "Linear Motor." By rapidly switching the polarity of the magnets in the track (North-South-North), the magnetic field pulls the train from the front and pushes it from behind. The wave of magnetism surfs the train forward.

**Advantages:**
1.  **Speed:** The Shanghai Maglev hits 430 km/h. The Japan L0 Series hit 603 km/h.
2.  **Maintenance:** No friction means no wear and tear on bits. 3.  **Climbing:** Maglevs can climb steeper hills than wheel-trains (which rely on grip).

**Disadvantages:**
Cost. You aren't just building a track; you are building a massive, precision-engineered machine that stretches for hundreds of miles. The infrastructure cost is 2-3x that of standard rail, which is why, despite the tech being 50 years old, few lines exist.
    `.trim(),
        questions: [
            {
...
1.  **Photoreceptor:** A simple patch of light-sensitive cells (Euglena). It can tell light from dark. 2.  **Cup Eye:** If the patch dents into a cup shape (Planaria worm), you can tell direction. The cup casts a shadow.
3.  **Pinhole Eye:** If the opening narrows (Nautilus), it creates a focused image, though dim. No lens needed.
4.  **Lens Eye:** A clear slime covers the hole to protect it. If the slime hardens, it bends light (refraction), focusing the image brightly. This is the eye of the Human and the Octopus.

Crucially, the Human Eye and the Octopus Eye look identical but are built differently. In humans, the nerve fibers are *in front* of the retina, creating a Blind Spot. It’s a "bad design" left over from our fish ancestors.
In octopuses, the nerves are *behind* the retina. No blind spot.

They arrived at the same solution (camera eye) from different starting points because physics dictates that a lens is the best way to form an image. Evolution is pragmatic; it finds the best engineering solution given the available parts.
    `.trim(),
        questions: [
            {
