...
export const batch10Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Phenomenon/Anomaly",
...
Viscosity is internal friction; it's what makes honey thick and water thin. A superfluid has no friction. If you stirred a cup of it, it would spin forever.

Its behavior is spooky. If you put it in an open cup, it will creep *up* the sides of the cup, flow over the rim, and drip down the outside until the cup is empty. It forms a "Rollin Film" just one atom thick that defies gravity to escape its container.

It can also pass through microscopic pores that would hold back any normal liquid. This is because the atoms in the fluid have lost their individual identity. They have collapsed into a single quantum state called a Bose-Einstein Condensate. They move in perfect unison.

Superfluids are also perfect heat conductors. If you heat one spot, the heat instantly disperses through the whole volume. Bubbles cannot form because the heat moves too fast to vaporize the liquid locally. It is a "quantum soup" that allows physicists to see quantum mechanics—usually hidden in the subatomic world—with the naked eye.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Chronology",
...
1.  **The Spinning Jenny (1764):** Invented by James Hargreaves, it allowed one worker to spin 8 threads at once. 2.  **The Water Frame (1769):** Richard Arkwright built a machine powered by a water wheel. This was crucial because it was too big for a cottage; it required a factory. The "factory system" was born.
3.  **The Power Loom (1785):** Edmund Cartwright mechanized the weaving process.

Production exploded. The price of cotton cloth fell by 90%. Suddenly, poor people could afford more than one set of clothes. Hygiene improved.

However, this hunger for cotton revitalized slavery in the American South. The invention of the Cotton Gin by Eli Whitney (1793) made harvesting cotton profitable enough to feed the British machines.

The textile mills also created the urban proletariat. Peasants moved from farms to miserable city slums (Manchester) to work 14-hour days. The Luddites—weavers who smashed the new machines—were not anti-technology; they were fighting for their livelihood. They were the first casualties of automation.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Ecosystem",
...
Without wolves, the Elk population exploded. They had no fear. They grazed lazily along the riverbanks, eating all the young willow and aspen trees. The riverbanks eroded. Beavers, which need willows for food and dams, disappeared. The landscape was degraded.

In 1995, wolves were reintroduced. The effect was a "Trophic Cascade"—a ripple effect down the food chain.

First, the wolves killed elk. But more importantly, they changed the *behavior* of the elk. The "Landscape of Fear" returned. Elk avoided the valleys and riverbanks where they were vulnerable. They retreated to the high ground.

This allowed the willows and aspens to regrow along the streams. With the trees back, the beavers returned. Beaver dams created ponds, which supported fish, amphibians, and waterfowl. The roots of the trees stabilized the riverbanks, reducing erosion. The physical geography of the river changed.

Scavengers (ravens, bears) also benefitted from the wolf kills. The reintroduction proved that top-down regulation is essential. You cannot remove the top brick of the pyramid without the base crumbling.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Philosophy/Context",
...
They believed in the inherent goodness of people and nature. Their core tenet was that society and its institutions (religion, political parties) corrupt the purity of the individual. People are at their best when they are "self-reliant" and independent.

Emerson’s essay "Self-Reliance" argued, "Whoso would be a man, must be a nonconformist." He urged Americans to stop imitating European culture and trust their own intuition—the "Oversoul" or divine spark within. Thoreau took this literally. He moved to a cabin on Walden Pond to live deliberately. In *Walden*, he critiqued the industrial economy, arguing that men had become "tools of their tools." He championed civil disobedience, refusing to pay taxes to a government that supported slavery and the Mexican-American War.

The movement was full of contradictions. They were individualists who formed a tight club. They critiqued the market but were savvy publishers. Yet, their legacy is the bedrock of American identity: the belief that the individual conscience is the highest authority, superior to any law or king.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Scenario",
...
The rational choice for an individual is *always* to betray (Deject). Think about it from A’s perspective:
...
The result? Both betray. Both get 2 years. If they had just trusted each other and stayed silent, they would have only got 1 year. The "rational" individual choice leads to a worse collective outcome. This is the Nash Equilibrium.

This explains real-world tragedies like the Arms Race (spending billions on nukes) or pollution. It is cheaper for me to pollute, but if everyone pollutes, we all die. Game theorists study how to break this trap—usually through "repeated games" (reputation) or external enforcement (contracts) that changes the payoff matrix to reward cooperation. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Mechanism/Effect",
        dominantSkill: "Factual Information",
        passage: `
...
Liquefaction occurs in loose, water-saturated sand or silt. Imagine a bucket of sand filled with water. The sand grains are touching each other, supporting the weight. The water fills the gaps (pores) between them.

When the earthquake shaking starts, the ground moves back and forth rapidly. This shaking tries to compress the sand. It packs the grains tighter. This squeezes the water in the pores. The water pressure shoots up.

If the pressure gets high enough, the water pushes the sand grains apart. They no longer touch. Friction drops to zero. The soil loses all shear strength. It turns into a heavy slurry.

Once the shaking stops, the sand settles, and water erupts on the surface as "sand boils" or mud volcanoes. This was devastating in the 1964 Niigata earthquake in Japan (where apartment blocks tipped over) and in the 2011 Christchurch earthquake. It proves that the danger of a quake is not just the shaking, but what lies beneath the foundation.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Definition/Scale",
...
To measure this, we use the pH scale (Potential of Hydrogen). It is logarithmic. A pH of 7 is neutral (pure water). A pH of 1 is a strong acid (stomach acid). A pH of 14 is a strong base (drain cleaner).

Because it is logarithmic, a change of 1 unit represents a 10-fold change in concentration. Lemon juice (pH 2) is not twice as acidic as tomato juice (pH 4); it is $10 times 10$, or 100 times more acidic.

Life requires a strict pH balance. Human blood must stay between 7.35 and 7.45. If it drops to 6.9, you die (acidosis). To maintain this, the body uses *Buffers*.

A buffer is a chemical sponge. It is a solution containing a weak acid and its conjugate base. If you add acid to the blood, the buffer absorbs the extra $H^+$. If you add base, it releases $H+$. This equilibrium allows biological systems to withstand chemical shocks that would otherwise be fatal.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Conflict",
...
Bell was a teacher of the deaf. He was trying to invent a "harmonic telegraph" to send multiple messages at once. He realized he could send the human voice. Gray was a professional electrical engineer. He had developed a similar liquid transmitter.

Bell’s lawyer arrived at the patent office first, in the morning. Gray’s lawyer arrived later. Legend says Bell cut in line or paid off a clerk, but there is no proof. What is true is that Bell’s patent (No. 174,465) became the most valuable single patent in history.

The irony is that Bell hadn't actually built a working model when he filed. He filed a description. Gray had a better technical design. But in patent law, "first to file" usually wins.

Bell famously made the first call ("Mr. Watson, come here!") three days *after* filing. Western Union, the giant telegraph company, initially laughed at the phone as a toy and refused to buy Bell's patent for \$100,000. They later regretted this and hired Gray to build a rival network, sparking a massive legal battle that Bell eventually won.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Experiment/Critique",
        dominantSkill: "Prose Summary",
        passage: `
...
The simulation was scheduled for two weeks. It lasted only six days. The "Guards" were given mirrored sunglasses and batons. They quickly became sadistic. They forced prisoners to clean toilets with their bare hands, stripped them naked, and deprived them of sleep.

The "Prisoners" were dehumanized (called by numbers). They suffered emotional breakdowns. One had to be released quickly due to uncontrollable screaming. Zimbardo argued this proved the "Power of the Situation." Good people will do evil things if placed in an evil system. It wasn't their personality (they were normal students); it was the *role* they were playing.

However, modern critics argue the study was flawed. Zimbardo acted as the "Prison Warden," actively encouraging the guards to be tough ("Demand Codeing"). It was theater, not science. The participants were acting out the stereotypes they had seen in movies. Despite the ethical and scientific failures, it remains a chilling demonstration of how easily human empathy can be turned off by a uniform.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Phenomenon/Evidence",
...
Rubin found that galaxies don't behave like this. The stars on the outer edge were moving just as fast as the stars near the center. This "Flat Rotation Curve" was impossible.

If the visible stars and gas were the only mass, the outer stars were moving so fast they should have flown off into space. The galaxy should have torn itself apart. The only explanation was that there was *missing mass*. A huge amount of invisible matter must be surrounding the galaxy (in a halo), providing the extra gravity to hold these high-speed stars in orbit. We call this *Dark Matter*.

It is not dust or gas (which blocks light). It is some exotic particle that does not interact with light at all. We only know it exists because of its gravity. Calculations suggest that Dark Matter makes up 85% of the matter in the universe. The stuff we can see—stars, planets, us—is just the foam on top of a dark ocean. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Structure",
        dominantSkill: "Factual Information",
        passage: `
...
First was the *Tzolkin* ("Divine Count"). It consisted of 260 days, created by interlocking two gears: a cycle of 13 numbers and a cycle of 20 named days. (13 x 20 = 260). This likely related to the human gestation period (9 months). It was used for religious ceremonies.

Second was the *Haab* ("Civil Calendar"). This was a solar year of 365 days. It had 18 months of 20 days, plus a scary 5-day period at the end called *Wayeb* ("The Nameless Days"), considered unlucky.
...
Third was the *Long Count*. This was a linear count of days beginning at the Maya creation date (August 11, 3114 BCE). It allowed them to record history over millions of years.

The famous "2012 apocalypse" idea came from a misunderstanding of the Long Count. On Dec 21, 2012, the "Baktun" cycle (approx 400 years) simply rolled over, like an odometer reaching 100,000. The Maya didn't predict the end of the world; they predicted a new celebration.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Design",
        dominantSkill: "Inference",
        passage: `
...
The stadium was designed with 80 separate entrances at ground level because it was an ellipse. Each entrance was numbered. The spectator's pottery ticket (*tessera*) listed the entrance number, the section, and the row.

Once inside, a complex system of corridors and stairs separated the social classes. The Senators sat near the arena (marble seats). The knights sat behind them. The plebeians (citizens) were higher up. The women and slaves were at the very top (wooden benches). The architecture physically enforced the social hierarchy; the classes never had to rub shoulders on the stairs.

The *vomitoria* were the wide passageways that spit the crowd out into the seats. The name comes from the Latin *vomere* (to spew forth), not because people were sick.

This system was so efficient that the entire stadium could be filled or emptied in 15 minutes. Modern stadiums still use the exact same design principles (multiple gates, section tunnels), proving that the Romans mastered the physics of human fluid dynamics.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Historical Context/Legacy",
        dominantSkill: "Negative Factual Information",
        passage: `
...
The Charter protected the rights of the *nobility*, not the common people. When it says "No free man shall be seized... except by the judgment of his peers," it meant rich landowners. Most of the population were serfs (unfree), so the Charter did nothing for them.

Furthermore, it failed. Pope Innocent III annulled it ten weeks later, calling it "shameful." Civil war broke out (The First Barons' War). The 1215 document was legally dead.

So why does it matter? It was re-issued by John's son (Henry III) to buy support. Over centuries, lawyers (like Edward Coke) re-interpreted it. They took the "Barons' rights" and expanded them to "Everyone's rights." They turned a failed peace treaty into a symbol that *The King is not above the Law*.

This mythical version inspired the American Constitution. The reality of 1215 was a feudal squabble; the legacy is the principle of Due Process.
    `.trim(),
        questions: [
            {
...
The **Bernoulli Explanation** focuses on pressure. The wing is curved on top (camber). The popular (and incorrect) "Equal Transit Time" theory says air must travel over the top and bottom in the same amount of time. Since the top path is longer, the air speeds up. Bernoulli's principle says fast air = low pressure. The high pressure on the bottom pushes the wing up.
*Correction:* The air on top *does* go faster, but it doesn't have to meet the bottom air. The "Equal Transit" part is a myth.

The **Newton Explanation** focuses on force. The wing is angled. As it moves, it deflects air *down*. Newton's Third Law (Action/Reaction) says if the wing pushes air down, the air pushes the wing up.

Neither is complete alone. The wing causes the air to turn. This turning creates a pressure difference (Bernoulli) *and* a downwash (Newton). They are two mathematical ways of describing the same physical event: the conservation of momentum.

A flat wing can fly (like a paper plane), proving you don't need a curved top. You just need an Angle of Attack to deflect the wind.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Process/Cycle",
        dominantSkill: "Sentence Insertion",
        passage: `
...
**Step 1: Carbon Fixation.** A simple $CO_2$ molecule from the air is attached to a 5-carbon sugar called RuBP. This reaction is catalyzed by the enzyme *Rubisco*. Rubisco is the most abundant protein on Earth, likely because it is slow and inefficient, so plants need a ton of it.

**Step 2: Reduction.** The cell uses the ATP and NADPH (from the light reactions) to charge up the new carbon chain, converting it into a high-energy sugar called G3P. **Step 3: Regeneration.** Some of the G3P leaves the cycle to become glucose (food). However, most of it is recycled. It uses more ATP to be rearranged back into RuBP, so the cycle can start again to catch the next $CO_2$.

It takes 6 turns of the cycle to make one glucose molecule. This process is basically "packaged sunlight." The energy in the bonds of the sugar you eat originally came from a photon hitting a leaf and driving this microscopic wheel.
    `.trim(),
        questions: [
            {
...
They painted *en plein air* (outdoors), thanks to the invention of paint in tubes. They noticed that shadows are not black; they are colored (often violet or blue), reflecting the sky.

They realized the eye does not see individual leaves on a distant tree; it sees a blur of green. To capture this, they broke the image into short, broken brushstrokes ("taches"). Up close, it is a mess. Step back, and your eye blends the strokes into a coherent image.

They were influenced by photography (capturing a fleeting moment) and Japanese prints (asymmetry). Monet painted the same haystack or cathedral dozens of times at different hours to show that the "object" doesn't matter; only the light falling on it matters. The haystack is red at sunset, blue in the morning. Impressionism shifted art from painting *things* to painting *perception*.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Symbolism",
        dominantSkill: "Inference",
        passage: `
...
Between 1949 and 1961, 2.5 million East Germans fled to the West. Crucially, these were the "best and brightest"—doctors, engineers, and teachers—who could get higher salaries in the West. This "Brain Drain" threatened to collapse the East German economy.
...
The West called it a prison wall. The East called it the "Anti-Fascist Protection Rampart," claiming it kept Western spies out. This was propaganda; the guns were pointed inward, at their own citizens.

Other than stopping the brain drain, the Wall stabilized the Cold War. It froze the status quo. It fell on November 9, 1989, due to a bureaucracy error. A GDR official, Günter Schabowski, confused the dates on a press release about relaxing travel restrictions. He announced the borders were open "immediately." Thousands of Berliners rushed the gates. The confused guards, outnumbered and receiving no orders, opened the barriers. The fall was not a military victory, but a peaceful revolution fueled by a clerical mistake.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Observation",
        dominantSkill: "Prose Summary",
        passage: `
...
*   **Bridging Capital:** Ties between people who are different (civil rights movement). It is "WD-40" (lubricant). He used bowling as a metaphor. The total number of people bowling had increased, but the number of people in "bowling leagues" had plummeted. People were bowling alone.

This trend appeared everywhere: attendance at town meetings, PTA, boy scouts, and dinner parties had all crashed since the 1960s. Putnam blamed "technological individualizing of leisure" (TV and later the internet) and suburban sprawl. We stay home and watch Friends instead of having friends.

The consequence is a decline in trust. When you don't know your neighbor, you don't trust them. This leads to political polarization and a breakdown of democracy, which relies on the ability of strangers to cooperate.
    `.trim(),
        questions: [
            {
...
**Drill-and-Blast** is sequential. Engineers drill holes in the rock face, pack them with explosives, blow it up, wait for the dust to settle ("mucking out"), and then reinforce the roof with shotcrete (sprayed concrete). It is slow and jerky. However, it is flexible. You can change shape or direction easily. It is preferred for short tunnels or weird geometries.

**The TBM** is a factory on wheels. It is a massive cylinder, often 100 meters long. The front is a rotating cutterhead with steel discs that grind the rock into chips.
Crucially, the TBM does everything at once. As it chews the rock, it simultaneously erects pre-cast concrete segments behind it to build the tunnel lining. It pushes itself forward using hydraulic jacks that push off the lining it just built.

TBMs are fast and continuous. They don't disturb the surface (great for cities like London). However, they are astronomically expensive and inflexible. If a TBM gets stuck (like "Bertha" in Seattle), you cannot just back it up. You have to dig a rescue shaft from the surface. They are designated for long, straight runs like the "Chunnel" (Channel Tunnel).
    `.trim(),
        questions: [
            {
...
It suggests that as Africa dried out, the forests receded and were replaced by tall grass savannas. Our ancestors were forced out of the trees.
...
2.  **Thermoregulation:** By standing up, we expose less surface area to the direct overhead sun and more to the cooling breeze. This allowed us to forage in the heat of midday when predators were sleeping.
3.  **Vision:** Standing up allowed us to see over the tall grass to spot lions.

However, new fossil evidence (*Ardipithecus*) challenges this. "Ardi" was a biped who lived in a *woodland*, not a savanna. This suggests we may have started walking upright *in the trees* (walking on branches like gibbons) before we ever hit the ground.

Regardless of the start, bipedalism freed our hands. Once we didn't need hands for walking, we could use them for tools. This feedback loop (Tools -> Better Food -> Bigger Brains) defined our trajectory.
    `.trim(),
        questions: [
            {
