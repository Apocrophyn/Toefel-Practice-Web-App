...
export const batch9Passages: AcademicQuestion[] = [
    {
        ...
        rhetoricalStructure: "Mechanism/Contrast",
...
Wind waves happen at the surface. Their energy is limited to the top few meters of the ocean. A tsunami involves the movement of the *entire* water column, from the seafloor to the surface.

In deep water, a tsunami is almost invisible. It travels at jetliner speeds (500 mph) but has a very long wavelength (100 miles) and a very low amplitude (maybe 1 foot high). A ship at sea wouldn't even feel it pass.

The danger arises when the wave approaches shallow water near the coast. This is "Shoaling." As the depth decreases, the friction with the seabed slows the front of the wave down. However, the back of the wave is still moving at 500 mph. The water piles up. The wavelength compresses, and the energy is forced upward, causing the wave height to grow from 1 foot to 50 or 100 feet.

When it hits land, it doesn't break like a surfer's wave. It surges like a rapidly rising tide that doesn't stop. It pushes inland with the weight of the ocean behind it, destroying buildings through hydrostatic force and debris impact.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Organization",
...
The League arose to solve the problem of piracy and feudal taxes. By traveling in convoys and hiring their own mercenaries, the Hansa merchants could safely transport timber, fur, wax, and dried fish across danger zones.

They established "Kontors" (foreign trading posts) in cities like London (the Steelyard) and Novgorod. These were cities within cities, governed by Hansa law, not local law. The League was not a government. It had no army or constitution. It enforced its will through the "Blockade." If a King tried to tax them unfairly, the League would stop all trade with his kingdom. For a medieval economy dependent on imported salt or grain, this was devastating. They once brought the King of Denmark to his knees simply by refusing to sell him herring.

The decline of the League came with the Rise of the Nation-State. As centralized monarchies in Sweden and England grew powerful, they forced the merchants to submit to royal authority. The discovery of the Americas also shifted trade routes to the Atlantic, leaving the Baltic backwater behind.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Classification/Comparison",
...
*Batesian Mimicry* involves a liar. A harmless species (the mimic) evolves to look like a dangerous or toxic species (the model). The classic example is the Viceroy butterfly, which looks nearly identical to the toxic Monarch butterfly.

Birds learn to avoid the Monarch because it tastes terrible. By looking like the Monarch, the tasty Viceroy gains protection. This strategy only works if the mimics are rare. If there are too many liars, the predators will realize the signal is fake and start eating both.

*Müllerian Mimicry* involves honest cooperation. Two or more harmful species evolve to look like *each other*. For example, many different species of stinging bees and wasps share the same yellow-and-black striped pattern.
...
In Batesian mimicry, the mimic is a parasite on the model's reputation. In Müllerian mimicry, it is a syndicate of shared defense. `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Context/Style",
...
Faulkner set his novels (like *The Sound and the Fury*) in the fictional Yoknapatawpha County, Mississippi. His central theme was the "burden of the past." The South, defeated in the Civil War, was haunted by the ghosts of slavery and lost aristocracy.

His characters are often grotesque—mentally unstable or physically deformed—representing the moral decay of the culture. In "A Rose for Emily," a woman sleeps next to the corpse of her lover for decades, a symbol of the South refusing to let go of dead traditions.

Stylistically, Faulkner was a modernist. He used "Stream of Consciousness," recording the chaotic, non-linear thoughts of his characters. He famously used long, winding sentences that spanned pages, mimicking the way memory spirals and overlaps.

Southern Gothic exposes the myth of the "genteel South." Behind the white columns and polite manners, Faulkner revealed violence, racism, and madness. He showed that the past is never dead. It's not even past.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Cause-Effect/Classification",
...
*Demand-Pull* inflation is often described as "too much money chasing too few goods." This happens when the economy is booming. Consumers have cash and want to buy cars and houses. If the factories cannot produce cars fast enough to meet this demand, they raise prices.
...
*Cost-Push* inflation is the inflation of scarcity. It happens when the cost of production rises, forcing companies to raise prices to maintain profit margins. The classic example is the Oil Shock of the 1970s. When the price of oil tripled, it cost more to transport food, manufacture plastic, and heat homes. Every business had to charge more.

This is more dangerous because it often leads to "Stagflation"—stagnant growth (unemployment) combined with inflation. In Demand-Pull, people are at least employed. In Cost-Push, people lose jobs *and* prices go up.

Central Banks (like the Federal Reserve) fight inflation by raising interest rates. This makes borrowing expensive, which cools down demand. It is a bitter medicine—deliberately slowing the economy to save the currency.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Process",
        dominantSkill: "Factual Information",
        passage: `
...
*Uplifted Plateaus* (like the Colorado Plateau) are created by tectonic forces. Massive sections of the crust are pushed upward by the mantle, but crucially, they remain horizontal. They don't fold into mountains.
...
*Volcanic Plateaus* (like the Deccan Traps in India or the Columbia Plateau in the US) are built from the top down. They are formed by "flood basalts." Instead of a volcano exploding, massive fissures open in the ground, and runny lava pours out like water.

This lava spreads over thousands of square miles, filling in valleys and depressions. It cools into a flat sheet of basalt. Layer after layer builds up over millions of years, creating a flat, high plain of rock.

Both types effect the climate. The Tibetan Plateau (caused by the collision of India and Asia) is so massive it physically blocks weather systems, creating the Monsoons that water half of humanity.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Narrative",
...
Charles Goodyear, an American inventor, spent years trying to stabilize rubber. He was obsessed, often impoverished and in and out of debtors' prison. He mixed rubber with everything—magnesia, lime, nitric acid—with no success.

The breakthrough happened by accident in 1839. Goodyear dropped a mixture of rubber and *sulfur* onto a hot stove. Instead of melting, the rubber charred and hardened. It stayed flexible but dry. He had discovered *Vulcanization* (named after Vulcan, the god of fire).

Chemically, the sulfur atoms form "cross-links" or bridges between the long polymer chains of the rubber. Imagine the rubber molecules are spaghetti. Uncooked, they slide past each other (gooey). The sulfur acts like staples connecting the noodles. They can still stretch, but the staples pull them back into shape.

Goodyear patented it, but died in debt, fighting lawsuits. However, his invention made the Industrial Revolution mobile. Without vulcanized rubber, there are no gaskets for steam engines, no belts for factories, and most importantly, no tires for the automobile.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Conflict/Chronology",
        dominantSkill: "Inference",
        passage: `
...
Marconi was a practical businessman. In the 1890s, he took the theories of Heinrich Hertz (radio waves) and built a device to transmit Morse code wirelessly. He saw it as a "wireless telegraph" for ships. In 1901, he famously transmitted the letter "S" across the Atlantic. He won the Nobel Prize.

However, Marconi used 17 of Tesla's patents to build his machine. Tesla had demonstrated the technology years earlier, in 1893. Tesla's vision was grander; he wanted to transmit voice and power wirelessly to the world.

The US Patent Office initially supported Tesla. But in 1904, they suddenly reversed their decision and awarded the patent to Marconi. Historians suspect influence from Marconi's wealthy backers (including Thomas Edison and Andrew Carnegie).

Tesla died penniless. Marconi died rich.

However, in 1943, months after Tesla's death, the US Supreme Court overturned Marconi's patent and ruled that Tesla was the true father of radio. This was partly strategic—the US government was being sued by the Marconi company for using radio in WWI, and by invalidating the patent (crediting the dead Tesla), they avoided paying royalties.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Experiment",
...
Bowlby observed war orphans. Children who were fed and safe but lacked a primary caregiver often withered, suffering from "failure to thrive." He realized the mother provides a "Secure Base" from which the child can explore the world.
...
The key is how the child reacts upon *return*. 1.  **Secure Attachment:** The child is upset when mom leaves but happy and easily soothed when she returns. This implies the parent is consistent and responsive.
...
3.  **Insecure-Anxious:** The child is hysterical when mom leaves and angry/clingy when she returns. This implies inconsistent parenting.

These early patterns became blueprints for adult relationships. Research suggests that securely attached children grow up to have stable marriages, while insecure children struggle with trust or intimacy. Attachment proved that love is not a luxury for a developing brain; it is a nutrient.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Discovery/Explanation",
        dominantSkill: "Sentence Insertion",
        passage: `
...
The light was "Redshifted" enormously. In astronomy, Redshift indicates an object is moving away from us. Due to the expansion of the universe, the faster it moves, the farther away it is. The redshift showed these objects were billions of light-years away.

To be visible from that distance, they had to be brighter than an entire galaxy of 100 billion stars. Yet, they were tiny—about the size of our solar system. How could so much energy fit in such a small box?

The answer is a *Supermassive Black Hole*. A Quasar is the nucleus of a young, active galaxy. At the center, a black hole (millions of times the mass of the sun) is feeding. As gas and dust spiral into the drain, they form an accretion disk. Friction heats this disk to millions of degrees, blasting out jets of radiation.

We are seeing the death screams of matter as it falls into the abyss.

Quasars are time machines. Because they are far away, we see them as they were billions of years ago. They were common in the early universe when galaxies were colliding and full of gas fuel. Today, most galaxies (like our Milky Way) have "starved" black holes that are quiet. Quasars are the violent adolescence of the cosmos.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Problem-Solution/Culture",
        dominantSkill: "Factual Information",
        passage: `
...
Technologically, they mastered insulation. The parka was a marvel for engineering. Made of caribou skin, the fur is hollow (trapping air). The Inuit wore two layers: the inner layer with fur facing *in* (against the skin) and the outer layer with fur facing *out*. This double-glazing effect is superior to modern synthetic expedition gear.

Shelter was equally ingenious. The *Igloo* (snow house) utilizes the insulating properties of snow. Even when it is -40°C outside, body heat and a seal-oil lamp can raise the interior temperature to near freezing (0°C). A melt-water seal forms on the inner wall, making it windproof.

Diet was the paradox. The Arctic has almost no plants. The Inuit diet was nearly 100% meat (seal, whale, caribou). Normally, this causes scurvy (Vitamin C deficiency). However, the Inuit ate much of the meat raw (*Inuit* means "eaters of raw meat"). Cooking destroys Vitamin C. Raw whale skin (*muktuk*) is rich in it.

Physiologically, the Inuit body type—compact and stocky—minimizes surface area to retain heat (Allen’s Rule). They also have a genetic adaptation that allows specialized fat metabolism, generating more body heat ("brown fat") than people from warmer climates. They are a testament to human plasticity.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Description/Context",
        dominantSkill: "Rhetorical Purpose",
        passage: `
...
It celebrated the *Machine*. Its motifs were sunbursts, zigzags, and stepped forms (like ziggurats). It used expensive, modern materials: aluminum, chrome, stainless steel, lacquer, and inlaid wood. It was the style of luxury ocean liners and fast trains.

The most famous example is the Chrysler Building in New York. Its stainless steel spire, with its repeating sunburst arches, looks like a car radiator grill. It symbolizes speed and capitalism.

Art Deco was also global and eclectic. It absorbed influences from the discovery of King Tut’s tomb (Egyptian motifs) and Aztec architecture. Interestingly, Art Deco survived the Depression. In the 1930s, it evolved into "Streamline Moderne." The expensive materials were replaced by cheaper concrete and glass blocks, but the shape became even more aerodynamic. Toasters, radios, and diners were designed with curved corners and speed lines, suggesting motion even when standing still. It was an optimistic style, promising a frictionless, technological future.
    `.trim(),
        questions: [
            {
...
The Viking expansion was driven by demographics and technology. Scandinavia had limited farmland. The invention of the Longship—shallow-draft, symmetrical, capable of sailing rivers and oceans—gave them mobility.

While they did raid, they also built a trade network connecting Baghdad to Newfoundland. In York (Jorvik) and Dublin, they established thriving market cities. They traded amber, furs, and walrus ivory for silk and silver. Excavations show they were skilled craftsmen (combs, jewelry) and had a complex legal system (*Thing* assemblies).

They were also the greatest explorers of the age. Leif Erikson reached North America (Vinland) 500 years before Columbus. They settled Iceland and Greenland.

The assimilation of the Vikings was rapid. In France, they were given land (Normandy) to stop them from raiding. Within a few generations, these "Northmen" became the "Normans," speaking French and building cathedrals, eventually conquering England in 1066. The Viking Age didn't end with a defeat; it ended because they successfully integrated into the Europe they helped build.
    `.trim(),
        questions: [
            {
...
**1. Mass:** The heavier the wall, the harder it is to shake. A thick concrete wall blocks more sound than a thin wood one. However, mass alone is inefficient (you need huge thickness to double the blocking).

**2. Damping:** This dissipates the energy. A specialized glue ("Green Glue") is sandwiched between two layers of drywall. When the sound hits the wall, the friction in the glue converts the vibration into tiny amounts of heat. The wall acts like a shock absorber.

**3. Decoupling:** This is the most effective method. Sound travels easily through solid studs. If the drywall on both sides is nailed to the same stud, the sound bridges across. Decoupling involves building a "room within a room" or using resilient clips so the two walls don't touch. The vibration cannot jump the gap.

**4. Absorption:** This handles the sound *inside* the room (echo). Fluffy materials like fiberglass or foam catch the sound waves and stop them from bouncing. While absorption makes a room sound better (less echo), it does *not* stop sound from leaving (soundproofing). You need mass and decoupling to stop the noise; you need foam to tune the tone.
    `.trim(),
        questions: [
            {
...
Antibiotics work by attacking specific bacterial machinery (e.g., destroying the cell wall). Bacteria reproduce rapidly. In a population of billions, a few will naturally have a random mutation that protects them from the drug.

When you take an antibiotic, you kill the 99.9% of normal bacteria. But the 0.1% of mutants survive. With the competition dead, these "superbugs" multiply and take over. This is Natural Selection in fast-forward.

What makes it terrifying is "Horizontal Gene Transfer." Bacteria act like open-source coders. A resistant bacterium can swap DNA (plasmids) with a non-resistant neighbor—even of a different species. They "teach" each other how to beat the drug.

Overuse drives this. Doctors prescribing antibiotics for viral flus (which drugs don't kill) or farmers feeding antibiotics to livestock to fatten them up introduce the selection pressure. We are running out of weapons. If we lose antibiotics, simple surgeries or cuts could once again become fatal.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Art",
        dominantSkill: "Vocabulary in Context",
        passage: `
...
Salvador Dalí is the icon of the movement. His "Paranoiac-Critical Method" involved inducing a state of hallucination to access subconscious images. His painting *The Persistence of Memory* (melting clocks) renders the impossible with photographic precision. The melting clocks likely symbolize the irrelevance of time in the dream state.

René Magritte took a more intellectual approach. His work questioned the nature of perception. In *The Treachery of Images*, he painted a realistic pipe and wrote "This is not a pipe" (*Ceci n'est pas une pipe*) under it. He was right: it is a *painting* of a pipe. You cannot smoke it. He forced the viewer to separate the object from the representation.

Surrealism used distinct techniques like "Automantism" (doodling without thinking) to bypass the censor of the conscious brain. The movement influenced film, advertising, and fashion. It validated the weird. It taught the 20th century that the irrational is not just nonsense; it is a deeper layer of truth waiting to be decoded.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Narrative/Cause-Effect",
        dominantSkill: "Inference",
        passage: `
...
Napoleon Bonaparte dreamed of a renewed French Empire in North America. He needed Louisiana to provide food for the lucrative sugar island of Saint-Domingue (Haiti). However, in 1791, the slaves of Haiti revolted, led by Toussaint Louverture. Napoleon sent massive armies to crush the rebellion, but they were defeated by guerrilla warfare and Yellow Fever. By 1802, Napoleon had lost 50,000 troops.

He gave up on the Americas. Without Haiti, Louisiana was useless to him. Also, he was about to go to war with Britain again and needed fast cash. When Jefferson’s diplomats arrived in Paris, they only wanted to buy the city of New Orleans (to control the Mississippi River trade). To their shock, Napoleon offered them the *entire* territory.

Jefferson hesitated. He was a "Strict Constructionist"—he believed the President could only do what the Constitution explicitly said. The Constitution said nothing about buying land. He struggled with his conscience but ultimately prized the pragmatism of expansion over legal purity. He signed the deal, opening the way for Westward Expansion and the rise of the US as a continental power.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Theory/Analogy",
        dominantSkill: "Sentence Insertion",
        passage: `
...
They argued that a city acts like a biological ecosystem. Just as plants compete for space in a forest, social groups compete for space in the city.
...
4.  **Residential Zone:** Middle-class suburbs. The theory was that groups move outward as they assimilate and get richer ("Succession"). A Polish immigrant arrives in Zone 2, works hard, and moves to Zone 3. A new group takes his place in Zone 2.

They also proposed "Social Disorganization Theory." They found that crime remained high in the Zone in Transition (Zone 2) regardless of *who* lived there—Irish, Italians, or Poles. When a group moved out, their crime rate dropped.

This proved that crime was not inherent to the *people* (ethnicity/biology), but to the *place* (environment). Poverty, overcrowding, and transience broke down social controls. The Chicago School shifted the blame for social ills from the individual to structure of the city itself.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Comparison/Constraint",
        dominantSkill: "Factual Information",
        passage: `
...
The *Gravity Dam* relies on sheer weight. It is a massive triangle of concrete. It is wider at the bottom because water pressure increases with depth. The dam pushes down harder than the water pushes forward. It uses friction with the ground to stop from sliding. The Grand Coulee Dam is a classic example. It is brute force engineering.

The *Arch Dam* relies on shape. It curves upstream (convex). When the water hits the arch, the force is directed sideways into the canyon walls. It works like a stone bridge turned on its side. Because the canyon walls take the load, the dam itself can be incredibly thin and elegant.

The constraint for an Arch Dam is geology. You need a narrow canyon with solid rock walls. If the rock is weak, the dam would push the canyon apart and collapse. The Hoover Dam is a hybrid (Arch-Gravity), using both weight and curve.

Dams are controversial. While they provide renewable hydroelectric power and irrigation control (turning deserts like California into farms), they destroy river ecosystems. They block salmon migration and trap sediment (silt) behind the wall, starving the delta downstream. The modern era has seen a shift toward removing dams to restore natural river flow.
    `.trim(),
        questions: [
            {
    ...
    },
    {
        ...
        rhetoricalStructure: "Chronology/Trend",
        dominantSkill: "Inference",
        passage: `
...
50 million years ago, the ancestor *Eohippus* ("Dawn Horse") lived in the dense forests of North America. It was the size of a dog (12 inches high). It had arched back, 4 toes on front feet, and low-crowned teeth. It was a browser, eating soft leaves and fruit, hiding in the bushes.
...
In the open, there is nowhere to hide. You must outrun the predator. The horse's legs grew longer. Crucially, the side toes lifted off the ground and disappeared, leaving only the middle toe (the hoof). Running on one toe is energy-efficient for high speeds. *Merychippus* represents this transition.

The diet changed to grass. Grass is tough; it contains silica (sand) which wears down teeth. The horse evolved massive, high-crowned molars that grow continuously throughout life to replace the worn surface.

The modern horse (*Equus*) appeared about 4 million years ago. Ironically, horses went extinct in the Americas 10,000 years ago (likely due to human hunting). They were reintroduced by the Spanish Conquistadors in the 1500s, reclaiming the grasslands that had shaped their anatomy.
    `.trim(),
        questions: [
            {
